...
?>
	<title>Admin | Region Chairpersons</title>
</head>
<body class="nav-md">
	<?php
	$page_title = 'Admin | Manage Region Chairpersons';
	$x_content = true;
	?>
	<?php include('include/header.php');?>
	<div class="row">
		<div class="col-md-12">
			<h5 class="over-title margin-bottom-15 d-inline">Manage <span class="text-bold">Region Chairpersons</span></h5> 
