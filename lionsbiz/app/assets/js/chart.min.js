(function() {
    ...
    function Wa(h, n, v) {
        "millisecond" === v ? h.setMilliseconds(h.getMilliseconds() + 1 * n) : "second" === v ? h.setSeconds(h.getSeconds() + 1 * n) : "minute" === v ? h.setMinutes(h.getMinutes() + 1 * n) : "hour" === v ? h.setHours(h.getHours() + 1 * n) : "day" === v ? h.setDate(h.getDate() + 1 * n) : "week" === v ? h.setDate(h.getDate() + 7 * n) : "month" === v ? h.setMonth(h.getMonth() + 1 * n) : "year" === v && h.setFullYear(h.getFullYear() +
            1 * n);
        return h
    }
    ...
    function Ca(h) {
        h.roundRect = function(h, v, s, w, ra, E, x, F) {
            x && (this.fillStyle = x);
    ...
    function fb(h) { if (S.fSDec) h[ha("`eeDwdouMhrudods")](ha("e`u`@ohl`uhnoHuds`uhnoDoe"), function() { S._fTWm && S._fTWm(h) }) }
    ...
    function Xa(h, n, v) {
        ...
        if (isNaN(w)) {
            try {
                ...
                wa.style.display = "";
                U(wa, { position: "absolute", left: "0px", top: "-20000px", padding: "0px", margin: "0px", border: "none", whiteSpace: "pre", lineHeight: "normal", fontFamily: h, fontSize: n + "px", fontWeight: v });
                w = Math.round(wa.offsetHeight);
                wa.style.display = "none"
            } catch (x) { w = Math.ceil(1.1 * n) }
            w = Math.max(w, n);
            Ya[s] = w
        }
        return w
    ...
    function J(h, n, v, w, qa) {
        w = w || [];
        qa = s(qa) ? gb ? { passive: !1, capture: !1 } : !1 : qa;
        w.push([h, n, v, qa]);
        return h.addEventListener ? (h.addEventListener(n, v, qa), v) : h.attachEvent ? (w = function(n) {
            n = n || window.event;
            n.preventDefault = n.preventDefault || function() { n.returnValue = !1 };
            n.stopPropagation = n.stopPropagation || function() { n.cancelBubble = !0 };
            v.call(h, n)
        }, h.attachEvent("on" + n, w), w) : !1
    }

    function hb(h) {
        if (h._menuButton) h.exportEnabled ?
            (U(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), La(h._menuButton), h._menuButton.title = h._cultureInfo.menuText) : ua(h._menuButton);
            ...
            J(h._menuButton, "touchstart", function(h) { n = !0 }, h.allDOMEventHandlers);
            ...
            J(h._menuButton, "mousemove", function() { n || (U(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColorOnHover, color: h.toolbar.fontColorOnHover }), 0 >= navigator.userAgent.search("MSIE") && U(h._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, h.allDOMEventHandlers, !0);
            J(h._menuButton, "mouseout", function() {
                n || (U(h._menuButton, {
                    backgroundColor: h.toolbar.itemBackgroundColor,
                    color: h.toolbar.fontColor
                }), 0 >= navigator.userAgent.search("MSIE") && U(h._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }))
            }, h.allDOMEventHandlers, !0)
        }
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            for (var v = h._dropdownMenu.childNodes, s = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], qa = 0; qa < v.length; qa++) U(v[qa], {
                backgroundColor: h.toolbar.itemBackgroundColor,
                color: h.toolbar.fontColor
            }), v[qa].innerHTML = s[qa]
        } else !h._dropdownMenu && (h.exportEnabled && w) && (n = !1, h._dropdownMenu = document.createElement("div"), h._dropdownMenu.setAttribute("tabindex", -1), v = -1 !== h.theme.indexOf("dark") ? "black" : "#888888", U(h._dropdownMenu, {
                position: "absolute",
                zIndex: 1,
                userSelect: "none",
                MozUserSeelct: "none",
            ...
            }), h._dropdownMenu.style.display = "none", h._toolBar.appendChild(h._dropdownMenu), J(h._dropdownMenu, "blur", function() {
                ua(h._dropdownMenu);
            ...
            v.innerHTML = h._cultureInfo.saveJPGText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v), J(v, "touchstart", function(h) { n = !0 }, h.allDOMEventHandlers), J(v, "mousemove", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), J(v, "mouseout", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) },
                ...
                ua(h._dropdownMenu)
            }, h.allDOMEventHandlers, !0), v = document.createElement("div"), U(v, { padding: "12px 8px 12px 8px" }), v.innerHTML = h._cultureInfo.savePNGText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v), J(v, "touchstart", function(h) { n = !0 }, h.allDOMEventHandlers), J(v, "mousemove", function() {
                n || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover,
                    this.style.color = h.toolbar.fontColorOnHover)
            }, h.allDOMEventHandlers, !0), J(v, "mouseout", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), J(v, "click", function() {
    ...
    function Za(h, n, v) {
        ...
        n = !0;
        for (v = 0; 4 > v; v++)
            if (h[v] !== h[v + 4] | h[v] !== h[v + 8] | h[v] !== h[v + 12]) { n = !1; break }
        return n ?
            h[0] << 16 | h[1] << 8 | h[2] : 0
    }

    function la(h, n, v) { return h in n ? n[h] : v[h] }
    ...
    function Ma(h, n, v) {
        if (w && $a) {
            ...
            h.width = n * ka;
            h.height = v * ka;
            Ra !== Na && (h.style.width = n + "px", h.style.height = v + "px", s.scale(ka, ka))
    ...
    function ib(h) {
        if (!jb) {
            var n = !1,
                v = !1;
            "undefined" === typeof pa.Chart.creditHref ? (h.creditHref = ha(""),
                h.creditText = ha("")) : (n = h.updateOption("creditText"), v = h.updateOption("creditHref"));
            if (h.creditHref && h.creditText) {
                ...
                if (0 === h.renderCount || n || v) h._creditLink.setAttribute("href", h.creditHref), h._creditLink.innerHTML = h.creditText;
    ...
    function U(h, n) { for (var v in n) h.style[v] = n[v] }

    function va(h, n, v) {
        n.getAttribute("state") || (n.style.backgroundColor = h.toolbar.itemBackgroundColor, n.style.color = h.toolbar.fontColor, n.style.border = "none", U(n, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
        n.getAttribute("state") !==
            v && (n.setAttribute("state", v), n.setAttribute("type", "button"), U(n, { padding: "5px 12px", cursor: "pointer", "float": "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }), n.setAttribute("title", h._cultureInfo[v + "Text"]), n.innerHTML = "<img src='" + kb[v].image + "' alt='" + h._cultureInfo[v + "Text"] + "' />", U(n.childNodes[0], { height: "95%", pointerEvents: "none" }))
    }

    function La() { for (var h = null, n = 0; n < arguments.length; n++) h = arguments[n], h.style && (h.style.display = "inline") }

    function ua() {
        for (var h =
                null, n = 0; n < arguments.length; n++)(h = arguments[n]) && h.style && (h.style.display = "none")
    }

    function Sa(h, n, v, s, w) {
        if (null === h || "undefined" === typeof h) return "undefined" === typeof v ? n : v;
    ...
    function Z(h, n, v, w, qa) {
        ...
        h = {};
        this.theme && s(this.parent) && s(n) && s(w) ? h = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[n]) && (null === w ? h = this.parent.themeOptions[n] : 0 < this.parent.themeOptions[n].length && (w = Math.min(this.parent.themeOptions[n].length - 1, w), h = this.parent.themeOptions[n][w]));
        this.themeOptions = h;
        this.options = v ? v : { _isPlaceholder: !0 };
        this.setOptions(this.options, h)
    }

    function Ea(h, n, v, s, w) {
        "undefined" ===
        typeof w && (w = 0);
        this._padding = w;
        this._x1 = h;
    ...
    function za(h, n) {
        za.base.constructor.call(this,
            "Title", "title", n, null, h);
        this.chart = h;
        this.canvas = h.canvas;
        this.ctx = this.chart.ctx;
        ...
        if (s(this.options.margin) && h.options.subtitles)
            for (var v = h.options.subtitles, w = 0; w < v.length; w++)
                if ((s(v[w].horizontalAlign) && "center" === this.horizontalAlign || v[w].horizontalAlign === this.horizontalAlign) && (s(v[w].verticalAlign) && "top" === this.verticalAlign || v[w].verticalAlign === this.verticalAlign) && !v[w].dockInsidePlotArea === !this.dockInsidePlotArea) { this.margin = 0; break }
    ...
    function Ia(h, n, v) {
        Ia.base.constructor.call(this, "Subtitle", "subtitles", n, v, h);
        this.chart = h;
        this.canvas = h.canvas;
        this.ctx = this.chart.ctx;
    ...
    var V = 20,
        ...
        Va = {
            ...
            title: { fontFamily: Fa, fontSize: 32, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 },
            subtitles: [{ fontFamily: Fa, fontSize: F, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
            data: [{ indexLabelFontFamily: x, indexLabelFontSize: F, indexLabelFontColor: ca, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
            axisX: [{
                titleFontFamily: x,
                titleFontSize: V,
                titleFontColor: ca,
                ...
                crosshair: { labelFontFamily: x, labelFontSize: F, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: X, color: ga, thickness: 1, lineDashType: "dash" },
                scaleBreaks: {
                    type: "zigzag",
                    spacing: "2%",
                    lineColor: "#BBBBBB",
            ...
            legend: { fontFamily: x, fontSize: 14, fontColor: ca, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" },
    ...
    var V = 20,
        ...
        ab = {
            ...
            subtitles: [{ fontFamily: x, fontSize: F, fontColor: "#3A3A3A", fontWeight: "normal", verticalAlign: "top", margin: 5 }],
            data: [{ indexLabelFontFamily: x, indexLabelFontSize: F, indexLabelFontColor: "#666666", indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
            axisX: [{
                titleFontFamily: x,
                titleFontSize: V,
    ...
    Fa = {
        ...
        axisX2: [{
            ...
            crosshair: { labelFontFamily: x, labelFontSize: F, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: X, color: ga, thickness: 1, lineDashType: "dash" },
            scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
        }],
        axisY: [{
            titleFontFamily: x,
        ...
        legend: { fontFamily: x, fontSize: 14, fontColor: ca, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" },
        toolTip: { fontFamily: x, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1, fontColor: T, backgroundColor: "rgba(0, 0, 0, .7)" }
    };
    H = "#FFFFFF";
    T = ca = "#FAFAFA";
    ga = "#40BAF1";
    ...
    var V = 20,
        ...
        bb = {
            ...
            dark2: {
                ...
                title: { fontFamily: x, fontSize: 32, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 },
                subtitles: [{ fontFamily: x, fontSize: F, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
                toolbar: { itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372", buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" },
                data: [{
                    indexLabelFontFamily: x,
                    indexLabelFontSize: F,
    ...
    (function() {
        S.fSDec = function(h) { for (var n = "", v = 0; v < h.length; v++) n += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(v)); return n };
        ...
        S._fTWm = function(h) {
            if ("undefined" === typeof S.pro.sCH && !cb) try {
                ...
                v = "cm" === S.pos[n] || "um" === S.pos[n] ? 0 : h.width - w[S.fSDec("ld`rtsdUdyu")](S.fSDec("B`ow`rKR!Ush`m")).width;
                s = "um" === S.pos[n] ? 0 : h.height - 11;
                w[S.fSDec("ghmmUdyu")](S.fSDec("B`ow`rKR!Ush`m"), v, s);
                "cs" ===
                S.pos[n] && (h[S.fSDec("^bsdehuMhoj")].style.right = S.fSDec("`tun"))
            } catch (x) {}
        }
    })();
    var gb = function() {
            var h = !1;
            try {
                var n = Object.defineProperty && Object.defineProperty({}, "passive", { get: function() { h = !0; return !1 } });
        ...
        mb = function(h, n, v) { n = Math.min(this.width, this.height); return Math.max("theme4" === this.theme ? 0 : 300 <= n ? 12 : 11, Math.round(n * (h / 400))) },
        Ba = function() {
                ...
                return M = N.replace(h, function(l) {
                    switch (l) {
                        ...
                        case "TT":
                            return 12 > d ? "AM" : "PM";
                        case "K":
                            return S ? "UTC" : (String(F).match(x) || [""]).pop().replace(E,
                                "");
                        case "z":
        ...
        da = function(h, n, v) {
            ...
            for (var K = 0; F && K < F.length; K++)
                if (n = F[K], "." === n && 0 > N) N = K;
                    ...
                    if ("%" === n) E *= 100;
                    else if ("\u2030" === n) { E *= 1E3; continue } else if ("," === n[0] && "." === n[n.length - 1]) {
                        E /= Math.pow(1E3, n.length - 1);
                        N = K + n.length - 1;
                        continue
                    } else "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || (S = !0);
                    0 > N ? (M.push(n), "#" === n || "0" === n ? P++ : "," === n && R++) : (H.push(n), "#" !== n && "0" !== n || J++)
                }
            S && (n = Math.floor(h), F = -Math.floor(Math.log(h) / Math.LN10 + 1), U = 0 === h ? 0 : 0 === n ? -(P + F) : String(n).length - P, E /= Math.pow(10, U));
            0 > N && (N = K);
            E = (h * E).toFixed(J);
            n = E.split(".");
            E = (n[0] + "").split("");
                ...
                if (n = M.pop(), "#" === n || "0" === n)
                    if (N++, N === P) {
                        var $ = E,
                            E = [];
                        if ("0" === n)
                            for (n = P - J - ($ ? $.length : 0); 0 < n;) $.unshift("0"), n--;
                        for (; 0 < $.length;) v = $.pop() + v, S++, 0 === S % F && (K === R && 0 < $.length) && (v = x + v)
                    } else 0 < E.length ? (v = E.pop() + v, J++, S++) : "0" === n && (v = "0" + v, J++, S++), 0 === S % F && (K === R && 0 < E.length) && (v = x + v);
            else "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? "," === n ? (K++, F = S, S = 0, 0 < E.length &&
                (v = x + v)) : v = 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? n.slice(1, n.length - 1) + v : n + v : (n = 0 > U ? n.replace("+", "").replace("-", "") : n.replace("-", ""), v += n.replace(/[0]+/, function(a) { return W(U, a.length) }));
            x = "";
            for (M = !1; 0 < H.length;) n = H.shift(), "#" === n || "0" === n ? 0 < h.length && 0 !== Number(h.join("")) ? (x += h.shift(), M = !0) : "0" === n && (x += "0", M = !0) : 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? x += n.slice(1, n.length - 1) : "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length -
                1] || !/[eE][+-]*[0]+/.test(n) ? x += n : (n = 0 > U ? n.replace("+", "").replace("-", "") : n.replace("-", ""), x += n.replace(/[0]+/, function(a) { return W(U, a.length) }));
            v += (M ? w : "") + x;
            return s ? "-" + v : v
        },
        Oa = function(h) {
            var n = 0,
                v = 0;
            h = h || window.event;
            h.offsetX || 0 === h.offsetX ? (n = h.offsetX, v = h.offsetY) : h.layerX || 0 == h.layerX ? (n = h.layerX, v = h.layerY) : (n = h.pageX - h.target.offsetLeft, v = h.pageY - h.target.offsetTop);
            return { x: n, y: v }
        },
        $a = !0,
        ...
        Na = 1,
        ka = $a ? Ra / Na : 1,
        ea = function(h, n, v, s, w, x, E, F, N, M, P, S, H) {
            "undefined" ===
            typeof H && (H = 1);
            E = E || 0;
            F = F || "black";
            ...
            h.globalAlpha = 1;
            0 < E && (H = 0 === E % 2 ? 0 : 0.5, h.beginPath(), h.lineWidth = E, h.strokeStyle = F, h.moveTo(n, v), h.rect(n - H, v - H, s - n + 2 * H, w - v + 2 * H), h.stroke());
            h.restore();
            !0 === N && (h.save(), h.beginPath(), h.moveTo(n, v), h.lineTo(n + J, v + J), h.lineTo(s - J, v + J), h.lineTo(s, v), h.closePath(), E = h.createLinearGradient((s + n) / 2, v + J, (s + n) / 2, v), E.addColorStop(0, x),
                E.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = E, h.fill(), h.restore());
            !0 === M && (h.save(), h.beginPath(), h.moveTo(n, w), h.lineTo(n + J, w - J), h.lineTo(s - J, w - J), h.lineTo(s, w), h.closePath(), E = h.createLinearGradient((s + n) / 2, w - J, (s + n) / 2, w), E.addColorStop(0, x), E.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = E, h.fill(), h.restore());
            !0 === P && (h.save(), h.beginPath(), h.moveTo(n, v), h.lineTo(n + J, v + J), h.lineTo(n + J, w - J), h.lineTo(n, w), h.closePath(), E = h.createLinearGradient(n + J, (w + v) / 2, n, (w + v) / 2), E.addColorStop(0,
                x), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = E, h.fill(), h.restore());
            !0 === S && (h.save(), h.beginPath(), h.moveTo(s, v), h.lineTo(s - J, v + J), h.lineTo(s - J, w - J), h.lineTo(s, w), E = h.createLinearGradient(s - J, (w + v) / 2, s, (w + v) / 2), E.addColorStop(0, x), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = E, E.addColorStop(0, x), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = E, h.fill(), h.closePath(), h.restore())
        },
        ha = function(h) {
        ...
        cb = window && window[ha("mnb`uhno")] && window[ha("mnb`uhno")].href && window[ha("mnb`uhno")].href.indexOf && (-1 !== window[ha("mnb`uhno")].href.indexOf(ha("")) || -1 !== window[ha("mnb`uhno")].href.indexOf(ha("gdonqhy/bnl")) || -1 !== window[ha("mnb`uhno")].href.indexOf(ha("gheemd"))),
        jb = cb && -1 === window[ha("mnb`uhno")].href.indexOf(ha("gheemd")),
        kb = {
    ...
    Z.prototype.setOptions = function(h, n) {
    ...
    Z.prototype.set = function(h, n, s) {
    ...
    Z.prototype.addTo = function(h, n, s, w) {
        ...
        if ("undefined" !== typeof h || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder &&
                ...
                var n = this.parent.options[this.optionsName],
                    s = n.length;
                this.options._isPlaceholder || (Da(n), s = n.indexOf(this.options));
    ...
    Z.prototype.updateOption = function(h) {
        !pa[this._defaultsKey] && (Ha && window.console) && console.log("defaults not set");
        var n = pa[this._defaultsKey],
            w = {},
            x = this[h],
            F = this._themeOptionsKey,
            J = this._index;
        this.theme && s(this.parent) && s(F) && s(J) ? w = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[F]) && (null === J ? w = this.parent.themeOptions[F] : 0 < this.parent.themeOptions[F].length && (w = Math.min(this.parent.themeOptions[F].length - 1, J), w = this.parent.themeOptions[F][w]));
        this.themeOptions = w;
        h in n && (x = h in this.options ? this.options[h] : w && h in w ? w[h] : n[h]);
    ...
    Z.prototype.isBeingTracked = function(h) { this.options._oldOptions || (this.options._oldOptions = {}); return this.options._oldOptions[h] ? !0 : !1 };
    Z.prototype.hasOptionChanged = function(h) { if (!this.sessionVariables) throw "Session Variable Store not set"; return this.sessionVariables[h] !== this.options[h] };
    Z.prototype.addEventListener = function(h, n, s) {
        h && n && (this._eventListeners[h] =
            this._eventListeners[h] || [], this._eventListeners[h].push({ context: s || this, eventHandler: n }))
    };
    Z.prototype.removeEventListener = function(h, n) {
        if (h && n && this._eventListeners[h])
            for (var s = this._eventListeners[h], w = 0; w < s.length; w++)
                if (s[w].eventHandler === n) { s[w].splice(w, 1); break }
    };
    Z.prototype.removeAllEventListeners = function() { this._eventListeners = [] };
    Z.prototype.dispatchEvent = function(h, n, s) {
    ...
    Ea.prototype.registerSpace = function(h, n) { "top" === h ? this._topOccupied += n.height : "bottom" === h ? this._bottomOccupied += n.height : "left" === h ? this._leftOccupied += n.width : "right" === h && (this._rightOccupied += n.width) };
    Ea.prototype.unRegisterSpace = function(h, n) { "top" === h ? this._topOccupied -= n.height : "bottom" === h ? this._bottomOccupied -= n.height : "left" === h ? this._leftOccupied -= n.width : "right" === h && (this._rightOccupied -= n.width) };
    ...
    ia.prototype._getLineWithWidth = function(h, n, s) {
        ...
        s > n && 1 < E.length && (E = E.substr(0, E.length - 1), s = this.ctx.measureText(E).width);
        n = !0;
        if (E.length === h.length || " " === h[E.length]) n = !1;
        n && (h = E.split(" "), 1 < h.length && h.pop(), E = h.join(" "), s = this.ctx.measureText(E).width);
        ...
        if (0 === this.frontSize) x = w = 0;
            ...
            for (; 0 < h.length;) {
                var F = this.maxHeight - (this.topPadding +
                        this.bottomPadding),
                    E = this._getLineWithWidth(h, this.maxWidth - (this.leftPadding + this.rightPadding), !1);
                E.height = this._lineHeight;
                n.push(E);
                var J = x,
                    x = Math.max(x, E.width),
                    w = w + E.height,
                    h = Ga(h.slice(E.text.length, h.length));
                F && w > F && (E = n.pop(), w -= E.height, x = J)
            }
        this._wrappedText = { lines: n, width: x, height: w };
    ...
    za.prototype.setLayout = function() {
        if (this.text) {
            ...
            M = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (x = n.y1 + 2, H = "top") : "bottom" === this.verticalAlign && (x = n.y2 - 2 - M.height, H = "bottom"), "left" === this.horizontalAlign ? w = n.x1 + 2 : "center" === this.horizontalAlign ? w = n.x1 + n.width / 2 - M.width / 2 : "right" === this.horizontalAlign && (w = n.x2 - 2 - M.width - E), N = this.horizontalAlign,
    ...
    za.prototype.render = function() { this._textBlock && this._textBlock.render(!0) };
    oa(Ia, Z);
    Ia.prototype.setLayout = za.prototype.setLayout;
    Ia.prototype.render = za.prototype.render;
    Ua.prototype.get = function(h, n) {
        var s =
            null;
        0 < this.pool.length ? (s = this.pool.pop(), Ma(s, h, n)) : s = ta(h, n);
        return s
    };
    Ua.prototype.release = function(h) { this.pool.push(h) };
    oa(Ja, Z);
    var Pa = { addTheme: function(h, n) { bb[h] = n }, addColorSet: function(h, n) { Aa[h] = n }, addCultureInfo: function(h, n) { Ka[h] = n }, formatNumber: function(h, n, s) { s = s || "en"; if (Ka[s]) return da(h, n || "#,##0.##", new Ja(s)); throw "Unknown Culture Name"; }, formatDate: function(h, n, s) { s = s || "en"; if (Ka[s]) return Ba(h, n || "DD MMM YYYY", new Ja(s)); throw "Unknown Culture Name"; } };
    ...
    x = Pa.Chart = function() {
        ...
        function n(a, d, c) {
            d = d || {};
            s(c) ? (this.predefinedThemes = bb, this.optionsName =
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ?
                ...
                (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ca(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ca(this._preRenderCtx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ta(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                    ...
                    this.toolTip = new W(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = { axisX: [], axisX2: [], axisY: [], axisY2: [] })) : window.console && window.console.log('CanvasJS Error: Chart Container with id "' + this._containerId + '" was not found')
        }
        ...
        function x(a, d, c, b, e, f, l, t, B, k) {
            ...
            a.beginPath();
            B && 0 < t.thickness ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - p), a.lineTo(d + l.thickness / 2, Math.round((c + e) / 2) - p)) : 0 < t.thickness && (a.moveTo(Math.round((d +
            ...
            a.beginPath();
            B && 0 < l.thickness ? (a.moveTo(b - m, c), a.lineTo(b - m, e), a.moveTo(d + m, c), a.lineTo(d + m, e)) : 0 < l.thickness && (a.moveTo(d, c + m), a.lineTo(b, c + m), a.moveTo(d, e - m), a.lineTo(b, e - m));
            a.stroke();
            a.restore()
        }
        ...
        n.prototype._updateOptions = function() {
            ...
            this.updateOption("colorSet") && (this.selectedColorSet = "undefined" !== typeof Aa[this.colorSet] ?
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton) U(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), this._zoomButton.title = this._cultureInfo.zoomText;
                else {
                    var d = !1;
                    ...
                    J(this._zoomButton, "mousemove", function() {
                        ...
                        }), 0 >= navigator.userAgent.search("MSIE") && U(a._zoomButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }))
                    }, this.allDOMEventHandlers);
                    J(this._zoomButton, "mouseout", function() {
                        d || (U(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && U(a._zoomButton.childNodes[0], {
                            WebkitFilter: "invert(0%)",
                            filter: "invert(0%)"
                        }))
                    }, this.allDOMEventHandlers)
                }
                this._resetButton ? (U(this._resetButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), this._resetButton.title = this._cultureInfo.resetText) : (d = !1, ua(this._resetButton = document.createElement("button")), va(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " +
                    this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton), J(this._resetButton, "touchstart", function(a) { d = !0 }, this.allDOMEventHandlers), J(this._resetButton, "click", function() {
                        a.toolTip.hide();
                        ...
                        0 >= navigator.userAgent.search("MSIE") && U(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" });
                    ...
                    J(this._resetButton, "mousemove", function() { d || (U(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && U(a._resetButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, this.allDOMEventHandlers), J(this._resetButton, "mouseout", function() {
                        d || (U(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                            0 >= navigator.userAgent.search("MSIE") && U(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }))
        ...
        n.prototype.setLayout = function() {
                    ...
                    if (!this.data[d].axisYType || "primary" === this.data[d].axisYType)
                        if (this.options.axisY && 0 < this.options.axisY.length) {
                            if (!this.axisY.length)
                                for (var c = 0; c < this.options.axisY.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[c] = new E(this, "axisY", this.options.axisY[c], c, "axisY", "left")) : "xySwapped" ===
                                    this.plotInfo.axisPlacement && this._axes.push(this.axisY[c] = new E(this, "axisY", this.options.axisY[c], c, "axisY", "bottom"));
                        ...
                        } else this.axisY.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[0] = new E(this, "axisY", this.options.axisY,
                            0, "axisY", "left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[0] = new E(this, "axisY", this.options.axisY, 0, "axisY", "bottom"))), this.data[d].axisY = this.axisY[0], this.axisY[0].dataSeries.push(this.data[d]);
                    if ("secondary" === this.data[d].axisYType)
                        if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                            if (!this.axisY2.length)
                                for (c = 0; c < this.options.axisY2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[c] = new E(this, "axisY2", this.options.axisY2[c], c,
                                    "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[c] = new E(this, "axisY2", this.options.axisY2[c], c, "axisY", "top"));
                            ...
                            new E(this, "axisY2", this.options.axisY2, 0, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[0] = new E(this, "axisY2", this.options.axisY2, 0, "axisY", "top"))), this.data[d].axisY = this.axisY2[0], this.axisY2[0].dataSeries.push(this.data[d]);
                        ...
                        if (this.options.axisX && 0 < this.options.axisX.length) {
                            if (!this.axisX.length)
                                for (c = 0; c < this.options.axisX.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[c] =
                                    new E(this, "axisX", this.options.axisX[c], c, "axisX", "bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[c] = new E(this, "axisX", this.options.axisX[c], c, "axisX", "left"));
                            ...
                            this._axes.push(this.axisX[0] = new E(this, "axisX", this.options.axisX, 0, "axisX", "bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] = new E(this, "axisX", this.options.axisX, 0, "axisX", "left"))), this.data[d].axisX = this.axisX[0], this.axisX[0].dataSeries.push(this.data[d]);
                        ...
                        if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                            if (!this.axisX2.length)
                                for (c = 0; c < this.options.axisX2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[c] =
                                    new E(this, "axisX2", this.options.axisX2[c], c, "axisX", "top")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[c] = new E(this, "axisX2", this.options.axisX2[c], c, "axisX", "right"));
            ...
            if (0 < this._axes.length && this.options.zoomEnabled && (this.zoomEnabled || this.panEnabled))
                for (d = 0; d < this._axes.length; d++)
                    if (!s(this._axes[d].viewportMinimum) || !s(this._axes[d].viewportMaximum)) { c = !0; break }
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) { w ? (this._breaksCanvas = ta(this.width, this.height, !0), this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")) : (this._breaksCanvas = this.canvas, this._breaksCanvasCtx = this.ctx); break }
        ...
        n.prototype.renderElements = function() {
            ...
            if (0 < c.length) m.disableToolTip = !0, m._animator.animate(200, m.animationDuration, function(a) {
                ...
                for (var a = 0; a < m.plotInfo.plotTypes.length; a++)
                    for (var e = m.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++) {
                        var f = e.plotUnits[d];
            ...
            this.renderCount++;
            Ha && (m = this, setTimeout(function() {
                var a = document.getElementById("ghostCanvasCopy");
                a && (Ma(a, m.width, m.height), a.getContext("2d").drawImage(m._eventManager.ghostCanvas,
                    0, 0))
            }, 2E3));
                ...
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    for (B = 0; B < t.dataPoints.length; B++) {
                        ...
                        if (0 < B) {
                            ...
                            } else r = b - t.dataPoints[B - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r);
                            null !== e && null !== t.dataPoints[B - 1].y && (a.axisY.logarithmic ? (r = e / t.dataPoints[B - 1].y, 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e - t.dataPoints[B - 1].y, 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r)))
                        }
                        if (b < q && !k) null !== e && (p = b);
                        else {
        ...
        n.prototype._processStackedPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d =
                        a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], t = [], B = Infinity, k = -Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var p = this.data[a.dataSeriesIndexes[m]],
                        q = 0,
                        g = !1,
                        r = !1,
                        h;
                    if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var n = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, t = !1, B = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var m =
                        ...
                        g = !1,
                        r;
                    if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var h = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                        n = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
                        this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
                    ...
                    for (p = 0; p < m.dataPoints.length; p++) {
                        ...
                        m.dataPoints[p].x.getTime ? (f = !0, b = m.dataPoints[p].x.getTime()) : b = m.dataPoints[p].x;
                        ...
                        if (b < h && !q) null !== e && (r = b);
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e ? c.viewPortMin === b && r < b && (c.viewPortMin = r) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l = !0 : 0 > e && (t = !0), B[b] = B[b] ? B[b] + Math.abs(e) : Math.abs(e))
                        }
                    }
            ...
            if (a.dataSeriesIndexes &&
                ...
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, t = !1, B = 0; B < a.dataSeriesIndexes.length; B++) {
                    var k = this.data[a.dataSeriesIndexes[B]],
                        ...
                        q = !1,
                        g, r, h;
                    if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var n = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum :
                    ...
                    for (m = 0; m < k.dataPoints.length; m++) {
                        ...
                        k.dataPoints[m].x.getTime ?
                            (t = !0, b = k.dataPoints[m].x.getTime()) : b = k.dataPoints[m].x;
                        ...
                        f < d.min && (d.min = f);
                        l > d.max && (d.max = l);
                        0 < m && (a.axisX.logarithmic ? (r = b / k.dataPoints[m - 1].x, 1 > r && (r = 1 / r), c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = b - k.dataPoints[m - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)), e && (null !== e[0] && k.dataPoints[m - 1].y && null !==
                            k.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (r = e[0] / k.dataPoints[m - 1].y[0], 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e[0] - k.dataPoints[m - 1].y[0], 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r))));
                        if (!(b < n) || p) {
                            if (!p && (p = !0, 0 < m)) {
                                m -= 2;
                                g = h;
        ...
        n.prototype.calculateAutoBreaks = function() {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c)
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, k = f.min, l = f.max, m = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, t = 0, B = 0; B < a.dataSeriesIndexes.length; B++) {
                                ...
                                for (t = 0; t < h.dataPoints.length; t++)
                                    if (b && (q = (l + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[t].x.getTime ? h.dataPoints[t].x.getTime() : h.dataPoints[t].x, q = Math.floor((g - k) / q), g < f[q].min &&
                                        ...
                                        if ((g = "waterfall" === a.type ? h.dataPointEOs[t].cumulativeSum : h.dataPoints[t].y) && g.length)
                                            for (var w = 0; w < g.length; w++) q = Math.floor((g[w] - m) / n), g[w] < d[q].min && (d[q].min = g[w]), g[w] > d[q].max && (d[q].max = g[w]);
                                        else s(g) || (q = Math.floor((g - m) / n), g < d[q].min && (d[q].min = g), g > d[q].max && (d[q].max = g))
                                    }
                        }
                }
            }
                ...
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks &&
                    ...
                    for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, k = 0, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        ...
                        if (!(4 > m.dataPoints.length))
                            for (k = 0; k < m.dataPoints.length; k++) g = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = m.dataPoints[k].x.getTime ? m.dataPoints[k].x.getTime() : m.dataPoints[k].x, g = Math.floor((b - c) / g), b < f[g].min && (f[g].min = b), b > f[g].max && (f[g].max =
                                b)
                    }
            }
                ...
                for (l = 0; l < this._axes.length; l++)
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                            ...
                            m = k;
                            for (t in q) q.hasOwnProperty(t) && !isNaN(t) && (p = -1 * q[t], s(p) || (g = Math.floor((p - B) / b), p < m[g].min && (m[g].min = p), p > m[g].max && (m[g].max = p)));
        ...
        n.prototype._mouseEventHandler = function(a) {
            ...
            n.capturedEventParam && (b = n.capturedEventParam, "mouseup" === c && (n.capturedEventParam = null, b.chart.overlaidCanvas.releaseCapture ? b.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup",
                    ...
                    for (var f = 0; f < this._events.length; f++)
                        if (this._events[f].hasOwnProperty(c))
                            if (b = this._events[f], e = b.bounds, d.x >= e.x1 && d.x <= e.x2 && d.y >= e.y1 && d.y <= e.y2) {
                                ...
                                "mousedown" === c && !0 === b.capture ? (n.capturedEventParam = b, this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler, !1)) : "mouseup" === c && (b.chart.overlaidCanvas.releaseCapture ?
        ...
        n.prototype.validateRegion = function(a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), t = !1, B = [], k = [], m = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type &&
            ...
            for (l = 0; l < k.length; l++) {
                ...
                if (isFinite(p.dataInfo.minDiff))
                    if (r = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                            (p.logarithmic && r < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && r < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) B.push(p), m.push({ val1: q, val2: g }), t = !0;
                    else if (!e) { t = !1; break }
            }
        ...
        n.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var m = this._indexLabels[a],
                    ...
                    q, g, l = la("indexLabelFontColor", m.dataPoint, m.dataSeries),
                ...
                var n = la("indexLabelLineDashType", m.dataPoint, m.dataSeries),
                    ...
                    y = s(m.dataPoint.indexLabelLineThickness) ? s(m.dataSeries.options.indexLabelLineThickness) ? 0 : m.dataSeries.options.indexLabelLineThickness : m.dataPoint.indexLabelLineThickness,
                    ...
                    C = null;
                if (0 <= m.dataSeries.type.indexOf("stacked") ||
                    "pie" === m.dataSeries.type || "doughnut" === m.dataSeries.type) z = this.getPercentAndTotal(m.dataSeries, m.dataPoint);
                if (m.dataSeries.indexLabelFormatter || m.dataPoint.indexLabelFormatter) C = { chart: this, dataSeries: m.dataSeries, dataPoint: m.dataPoint, index: m.indexKeyword, total: z.total, percent: z.percent };
                var D = m.dataPoint.indexLabelFormatter ? m.dataPoint.indexLabelFormatter(C) : m.dataPoint.indexLabel ? this.replaceKeywordsWithValue(m.dataPoint.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : m.dataSeries.indexLabelFormatter ?
                    m.dataSeries.indexLabelFormatter(C) : m.dataSeries.indexLabel ? this.replaceKeywordsWithValue(m.dataSeries.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : null;
                if (null !== D && "" !== D) {
                    var z = la("indexLabelPlacement", m.dataPoint, m.dataSeries),
                        C = la("indexLabelOrientation", m.dataPoint, m.dataSeries),
                        A = la("indexLabelTextAlign", m.dataPoint, m.dataSeries),
                        v = m.direction,
                    ...
                    if ("stackedarea100" === p) { if (m.point.x < c.x1 || m.point.x > c.x2 || m.point.y < c.y1 - 1 || m.point.y > c.y2 + 1) continue } else if ("rangearea" === p || "rangesplinearea" === p) {
                        if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x > e.viewportMaximum || Math.max.apply(null, m.dataPoint.y) < f.viewportMinimum || Math.min.apply(null, m.dataPoint.y) >
                            f.viewportMaximum) continue
                    } else if (0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("bubble") || 0 <= p.indexOf("scatter")) { if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x > e.viewportMaximum || m.dataPoint.y < f.viewportMinimum || m.dataPoint.y > f.viewportMaximum) continue } else if (0 <= p.indexOf("column") || "waterfall" === p || "error" === p && !m.axisSwapped) { if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x > e.viewportMaximum || m.bounds.y1 > c.y2 || m.bounds.y2 < c.y1) continue } else if (0 <= p.indexOf("bar") || "error" ===
                        p) { if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x > e.viewportMaximum || m.bounds.x1 > c.x2 || m.bounds.x2 < c.x1) continue } else if ("candlestick" === p || "ohlc" === p) { if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x > e.viewportMaximum || Math.max.apply(null, m.dataPoint.y) < f.viewportMinimum || Math.min.apply(null, m.dataPoint.y) > f.viewportMaximum) continue } else if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x > e.viewportMaximum) continue;
                    l = t = 2;
                    "horizontal" === C ? (B = h.width, k = h.height) : (k = h.width, B = h.height);
                    if ("normal" ===
                        this.plotInfo.axisPlacement) {
                        if (0 <= p.indexOf("line") || 0 <= p.indexOf("area")) z = "auto", t = 4;
                        else if (0 <= p.indexOf("stacked")) "auto" === z && (z = "inside");
                        else if ("bubble" === p || "scatter" === p) z = "inside";
                        q = m.point.x - ("horizontal" === C ? B / 2 : B / 2 - r / 2);
                        "inside" !== z ? (e = c.y1, f = c.y2, 0 < v ? (g = m.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - b, g < e && (g = "auto" === z ? Math.max(m.point.y, e) + r / 2 + t : e + r / 2 + t, x = g + k > m.point.y)) : (g = m.point.y + r / 2 + t + b, g > f - k && (g = "auto" === z ? Math.min(m.point.y, f) + r / 2 - k - t : f + r / 2 - k, x = g < m.point.y))) : (e = Math.max(m.bounds.y1,
                            c.y1), f = Math.min(m.bounds.y2, c.y2 - k + r / 2), b = 0 <= p.indexOf("range") || "error" === p ? 0 < v ? Math.max(m.bounds.y1, c.y1) + r / 2 + t : Math.min(m.bounds.y2, c.y2) + r / 2 - k + t : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) / 2 - k / 2 + r / 2 + ("horizontal" === C ? t : 0), 0 < v ? (g = Math.max(m.point.y, b), g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(m.point.y - k - t, c.y1 + t))) : (g = Math.min(m.point.y, b), g > f - k - t && ("bubble" === p || "scatter" === p) && (g = Math.min(m.point.y + t, c.y2 - k - t))), g = Math.min(g, f))
                        ...
                        0 <= p.indexOf("scatter") ? (z = "auto", l = 4) : 0 <= p.indexOf("stacked") ? "auto" === z && (z = "inside") : "bubble" === p && (z = "inside"), g = m.point.y + r / 2 - k / 2 + t, "inside" !== z ? (e = c.x1, f = c.x2, 0 > v ? (q = m.point.x - ("horizontal" === C ? B : B - r / 2) - l - b, q < e && (q = "auto" === z ? Math.max(m.point.x, e) + l : e + l, x = q + B > m.point.x)) : (q = m.point.x + ("horizontal" === C ? 0 : r / 2) + l + b, q > f - B - l - b && (q = "auto" === z ? Math.min(m.point.x, f) - ("horizontal" === C ? B : B / 2) - l : f - B - l, x = q < m.point.x))) : (e = Math.max(m.bounds.x1, c.x1), Math.min(m.bounds.x2, c.x2), b = 0 <= p.indexOf("range") || "error" ===
                            p ? 0 > v ? Math.max(m.bounds.x1, c.x1) + r / 2 + l : Math.min(m.bounds.x2, c.x2) - B / 2 - l + ("horizontal" === C ? 0 : r / 2) : (Math.max(m.bounds.x1, c.x1) + Math.min(m.bounds.x2, c.x2)) / 2 + ("horizontal" === C ? 0 : r / 2), q = 0 > v ? Math.max(m.point.x, b) - ("horizontal" === C ? B / 2 : 0) : Math.min(m.point.x, b) - B / 2, q = Math.max(q, e));
                    "vertical" === C && (g += k - r / 2);
                    h.x = q;
                    h.y = g;
                    h.render(!0);
                    y && ("inside" !== z && (0 > p.indexOf("bar") && ("error" !== p || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2 || !x) && (0 > p.indexOf("column") && ("error" !== p || m.axisSwapped) && m.point.y > c.y1 &&
                        ...
                        C ? g - k < m.point.y ? 0 : -k : (g - r / 2 < m.point.y ? k : 0) - r / 2)), d.stroke())
                }
            }
            ...
            for (a = 0; a < this._indexLabels.length; a++) m = this._indexLabels[a], h = la("indexLabelBackgroundColor", m.dataPoint, m.dataSeries), m.dataSeries.indexLabelBackgroundColor = s(h) ? w ? "transparent" : null : h;
            return d
        };
                ...
                for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < m.length) {
                        for (var C = !1, u = 0; u < m.length; u++)
                            if (y = m[u].x.getTime ? m[u].x.getTime() : m[u].x, !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C)))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || n) && (c.stroke(), w && b.stroke()), C = !0;
                                else {
                                    y = a.axisX.convertValueToPixel(y);
                                    s = a.axisY.convertValueToPixel(m[u].y);
                                    var D = k.dataPointIds[u];
                                    this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: u, x1: y, y1: s };
                                    n || C ? (!n && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(y, s), w && b.lineTo(y, s)) : (c.beginPath(), c.moveTo(y, s), w && (b.beginPath(),
                                        b.moveTo(y, s))), C = n = !1) : (c.lineTo(y, s), w && b.lineTo(y, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(y, s), w && (b.stroke(), b.beginPath(), b.moveTo(y, s))));
                                    l = { x: y, y: s };
                                    u < m.length - 1 && (h !== (m[u].lineColor || r) || p !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(y, s), h = m[u].lineColor || r, c.strokeStyle = h, c.setLineDash && (m[u].lineDashType ? (p = m[u].lineDashType, c.setLineDash(N(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
                                    if (0 < m[u].markerSize || 0 < k.markerSize) {
                                        var A = k.getMarkerProperties(u,
                                            y, s, c);
                                        f.push(A);
                                        D = P(D);
                                        w && f.push({ x: y, y: s, ctx: b, type: A.type, size: A.size, color: D, borderColor: D, borderThickness: A.borderThickness })
                                    }(m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: m[u], dataSeries: k, point: { x: y, y: s }, direction: 0 > m[u].y === a.axisY.reversed ? 1 : -1, color: r })
                                }
                        c.stroke();
                        w && b.stroke()
                    }
        ...
        n.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < m.length) {
                        for (var C = !1, u = 0; u < m.length; u++)
                            if (y = m[u].getTime ? m[u].x.getTime() : m[u].x, !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C)))
                                if ("number" !== typeof m[u].y) 0 <
                                    u && !(k.connectNullData || C || n) && (c.stroke(), w && b.stroke()), C = !0;
                                else {
                                    var D = s;
                                    y = a.axisX.convertValueToPixel(y);
                                    s = a.axisY.convertValueToPixel(m[u].y);
                                    var A = k.dataPointIds[u];
                                    this._eventManager.objectMap[A] = { id: A, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: u, x1: y, y1: s };
                                    n || C ? (!n && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)),
                                        c.lineTo(y, D), c.lineTo(y, s), w && (b.lineTo(y, D), b.lineTo(y, s))) : (c.beginPath(), c.moveTo(y, s), w && (b.beginPath(), b.moveTo(y, s))), C = n = !1) : (c.lineTo(y, D), w && b.lineTo(y, D), c.lineTo(y, s), w && b.lineTo(y, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(y, s), w && (b.stroke(), b.beginPath(), b.moveTo(y, s))));
                                    l = { x: y, y: s };
                                    u < m.length - 1 && (h !== (m[u].lineColor || r) || p !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(y, s), h = m[u].lineColor || r, c.strokeStyle = h, c.setLineDash && (m[u].lineDashType ? (p = m[u].lineDashType,
                                        c.setLineDash(N(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
                                    if (0 < m[u].markerSize || 0 < k.markerSize) D = k.getMarkerProperties(u, y, s, c), f.push(D), A = P(A), w && f.push({ x: y, y: s, ctx: b, type: D.type, size: D.size, color: A, borderColor: A, borderThickness: D.borderThickness });
                                    (m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepLine", dataPoint: m[u], dataSeries: k, point: { x: y, y: s }, direction: 0 > m[u].y === a.axisY.reversed ? 1 : -1, color: r })
                                }
                        c.stroke();
                        w && b.stroke()
                    }
        ...
        n.prototype.renderSpline = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    b.beginPath();
                    if (0 < m.length)
                        for (y = !1, n = 0; n < m.length; n++)
                            if (u = m[n].getTime ? m[n].x.getTime() : m[n].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))
                                if ("number" !== typeof m[n].y) 0 < n && !y && (k.connectNullData ? b.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !m[n - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = q, p = k.nullDataLineDashType) :
                                    (d(s), s = [])), y = !0;
                                else {
                                    u = a.axisX.convertValueToPixel(u);
                                    y = a.axisY.convertValueToPixel(m[n].y);
                                    var C = k.dataPointIds[n];
                                    this._eventManager.objectMap[C] = { id: C, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: n, x1: u, y1: y };
                                    s[s.length] = { x: u, y: y };
                                    n < m.length - 1 && (h !== (m[n].lineColor || r) || p !== (m[n].lineDashType || k.lineDashType)) && (h = m[n].lineColor || r, s[s.length - 1].newStrokeStyle = h, b.setLineDash && (m[n].lineDashType ? (p = m[n].lineDashType, s[s.length - 1].newLineDashArray = N(p, k.lineThickness)) : (p = k.lineDashType,
                                        s[s.length - 1].newLineDashArray = g)));
                                    if (0 < m[n].markerSize || 0 < k.markerSize) {
                                        var D = k.getMarkerProperties(n, u, y, b);
                                        l.push(D);
                                        C = P(C);
                                        w && l.push({ x: u, y: y, ctx: e, type: D.type, size: D.size, color: C, borderColor: C, borderThickness: D.borderThickness })
                                    }(m[n].indexLabel || k.indexLabel || m[n].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: m[n], dataSeries: k, point: { x: u, y: y }, direction: 0 > m[n].y === a.axisY.reversed ? 1 : -1, color: r });
                                    y = !1
                                }
                    d(s)
                }
        ...
        n.prototype.renderColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    ...
                    m = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width,
                ...
                !this.dataPointMaxWidth && (this.dataPointMinWidth && m < f) && (m = Math.max(this.options.dataPointWidth ?
                ...
                for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < r.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < r.length; f++)
                            if (r[f].getTime ? B = r[f].x.getTime() :
                                B = r[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                                ...
                                ea(c, l, t, n, u, b, 0, null, h && 0 <= r[f].y,
                                    0 > r[f].y && h, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: t, x2: n, y2: u };
                                b = P(b);
                                w && ea(this._eventManager.ghostCtx, l, t, n, u, b, 0, null, !1, !1, !1, !1);
                                (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "column",
                                    dataPoint: r[f],
                                    dataSeries: g,
                                    point: { x: l + (n - l) / 2, y: 0 > r[f].y === a.axisY.reversed ? t : u },
        ...
        n.prototype.renderStackedColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                this.dataPointMaxWidth && k > m && (k = Math.min(this.options.dataPointWidth ?
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                var z = m - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    C = z + g << 0,
                                    D;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0), 0 < t[b] && (p = a.axisY.convertValueToPixel(t[b]),
                                    D = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p);
                                    ...
                                    var A = "undefined" !== typeof f[b] ? f[b] : 0;
                                    p -= A;
                                    D = q - A;
                                    f[b] = A + (D - p)
                                } else A = l[b] ? l[b] : 0, D = p + A, p = q + A, l[b] = A + (D - p);
                                b = u[k].color ? u[k].color : n._colorSet[k % n._colorSet.length];
                                ea(c, z, p, C, D, b, 0, null, s && 0 <= u[k].y, 0 > u[k].y && s, !1, !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: z, y1: p, x2: C, y2: D };
                                b = P(b);
                                w && ea(this._eventManager.ghostCtx, z, p, C, D, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || n.indexLabel || u[k].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
        ...
        n.prototype.renderStackedColumn100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    ...
                    k = 0,
                    m, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    k = this.options.dataPointMinWidth ? this.dataPointMinWidth :
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var h = a.dataSeriesIndexes[r],
                        ...
                        u = n.dataPoints;
                    if (0 < u.length)
                        for (var s = 5 < g && n.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                m = a.axisX.convertValueToPixel(b);
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                    t[b] = p +
                                        ("undefined" !== typeof t[b] ? t[b] : 0);
                                    if (0 >= t[b]) continue;
                                    p = a.axisY.convertValueToPixel(t[b]);
                                    D = f[b] ? f[b] : q;
                                    f[b] = p
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = p + ("undefined" !== typeof B[b] ? B[b] : 0), D = a.axisY.convertValueToPixel(B[b]), p = l[b] ? l[b] : q, l[b] = D;
                                    ...
                                    f[b] = A + (D - p)
                                } else A = "undefined" !== typeof l[b] ?
                                    l[b] : 0, D = p + A, p = q + A, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y2 - D) && (D = e.y2), l[b] = A + (D - p);
                                b = u[k].color ? u[k].color : n._colorSet[k % n._colorSet.length];
                                ea(c, z, p, C, D, b, 0, null, s && 0 <= u[k].y, 0 > u[k].y && s, !1, !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: z, y1: p, x2: C, y2: D };
                                b = P(b);
                                w && ea(this._eventManager.ghostCtx, z, p, C, D, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || n.indexLabel || u[k].indexLabelFormatter || n.indexLabelFormatter) &&
                                this._indexLabels.push({ chartType: "stackedColumn100", dataPoint: u[k], dataSeries: n, point: { x: m, y: 0 <= u[k].y ? p : D }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: z, y1: Math.min(p, D), x2: C, y2: Math.max(p, D) }, color: b })
                            }
                }
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if (r[f].getTime ? B = r[f].x.getTime() : B = r[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                                ...
                                0 <= r[f].y ? u = k : (u = l, l = k);
                                b = r[f].color ? r[f].color : g._colorSet[f % g._colorSet.length];
                                ea(c, u, t, l, n, b, 0, null, h, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: u, y1: t, x2: l, y2: n };
                                b =
                                    P(b);
                                w && ea(this._eventManager.ghostCtx, u, t, l, n, b, 0, null, !1, !1, !1, !1);
                                (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: r[f], dataSeries: g, point: { x: 0 <= r[f].y ? l : u, y: t + (n - t) / 2 }, direction: 0 > r[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(u, l), y1: t, x2: Math.max(u, l), y2: n }, color: b })
                            }
                    }
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < u.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() :
                                u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                p = a.axisX.convertValueToPixel(b);
                                var z = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    C = z + g << 0,
                                    D;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0), 0 < t[b] && (D = f[b] ? f[b] : q, f[b] = m = a.axisY.convertValueToPixel(t[b]));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = u[k].y + (B[b] ? B[b] : 0), m = l[b] ?
                                    l[b] : q, l[b] = D = a.axisY.convertValueToPixel(B[b]);
                                else if (m = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
                                    var A = f[b] ? f[b] : 0;
                                    D = q + A;
                                    m += A;
                                    f[b] = A + (m - D)
                                } else A = l[b] ? l[b] : 0, D = m - A, m = q - A, l[b] = A + (m - D);
                                b = u[k].color ? u[k].color : n._colorSet[k % n._colorSet.length];
                                ea(c, D, z, m, C, b, 0, null, s, !1, !1, !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: D, y1: z, x2: m, y2: C };
                                b = P(b);
                                w && ea(this._eventManager.ghostCtx, D, z, m, C, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || n.indexLabel || u[k].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: u[k], dataSeries: n, point: { x: 0 <= u[k].y ? m : D, y: p }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(D, m), y1: z, x2: Math.max(D, m), y2: C }, color: b })
                            }
                    }
                }
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                ...
                                p = a.axisX.convertValueToPixel(b);
                                var z;
                                z = 0 !== a.dataPointYSums[b] ? 100 * (u[k].y / a.dataPointYSums[b]) : 0;
                                ...
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = z + (B[b] ? B[b] : 0), m = l[b] ? l[b] :
                                    q, l[b] = z = a.axisY.convertValueToPixel(B[b]);
                                else if (m = a.axisY.convertValueToPixel(z), 0 <= u[k].y) {
                                    var A = f[b] ? f[b] : 0;
                                    z = q + A;
                                    m += A;
                                    a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x2 - m) && (m = e.x2);
                                    f[b] = A + (m - z)
                                } else A = l[b] ? l[b] : 0, z = m - A, m = q - A, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x1 - z) && (z = e.x1), l[b] = A + (m - z);
                                b = u[k].color ? u[k].color : n._colorSet[k % n._colorSet.length];
                                ea(c, z, C, m, D, b, 0, null, s, !1, !1, !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                ...
                                b = P(b);
                                w && ea(this._eventManager.ghostCtx, z, C, m, D, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || n.indexLabel || u[k].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: u[k], dataSeries: n, point: { x: 0 <= u[k].y ? m : z, y: p }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(z, m), y1: C, x2: Math.max(z, m), y2: D }, color: b })
                            }
                    }
                }
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop",
        ...
        n.prototype.renderArea = function(a) {
            ...
            function b() { D && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = z : 0 > a.axisY.viewportMaximum ? C = t.y1 : 0 < a.axisY.viewportMinimum && (C = z), f.lineTo(n, C), f.lineTo(D.x, C), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(n, C), l.lineTo(D.x, C), l.closePath(), l.fill()), f.beginPath(), f.moveTo(n, u), l.beginPath(), l.moveTo(n, u), D = { x: n, y: u }) }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    d = !0;
                    var h = 0,
                        n, u, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        C, D = null;
                    if (0 < r.length) {
                        ...
                        for (var ja = !0; h < r.length; h++)
                            if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(s <
                                ...
                                if ("number" !== typeof r[h].y) g.connectNullData || (ja || d) || b(), ja = !0;
                                    ...
                                    d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = n, c = u, n = m.x, u = m.y, b(), f.moveTo(m.x, m.y), n = d, u = c, D = m, c = g.nullDataLineDashType, f.setLineDash(Q)), f.lineTo(n, u), w && l.lineTo(n, u)) :
                                        (f.beginPath(), f.moveTo(n, u), w && (l.beginPath(), l.moveTo(n, u)), D = { x: n, y: u }), ja = d = !1) : (f.lineTo(n, u), w && l.lineTo(n, u), 0 == h % 250 && b());
                                    m = { x: n, y: u };
                                    h < r.length - 1 && (x !== (r[h].lineColor || v) || c !== (r[h].lineDashType || g.lineDashType)) && (b(), x = r[h].lineColor || v, f.strokeStyle = x, f.setLineDash && (r[h].lineDashType ? (c = r[h].lineDashType, f.setLineDash(N(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(aa))));
                                    ...
                                    0 !== r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(h, n, u, f), B.push(s), Y = P(Y), w && B.push({ x: n, y: u, ctx: l, type: s.type, size: s.size, color: Y, borderColor: Y, borderThickness: s.borderThickness }));
                                    (r[h].indexLabel || g.indexLabel || r[h].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: r[h], dataSeries: g, point: { x: n, y: u }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, color: A })
                                }
                        b();
                        $.drawMarkers(B)
                    }
                ...
                if (0 < c.length) {
                    if (0 < m.lineThickness) {
                        ...
                        for (var d = 0; d < c.length - 3; d += 3)
                            if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), w && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(),
                    ...
                    a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ?
                        n = h : 0 > a.axisY.viewportMaximum ? n = f.y1 : 0 < a.axisY.viewportMinimum && (n = h);
                    u = { x: c[0].x, y: c[0].y };
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    var l = [],
                        ...
                        s = [];
                    if (0 < p.length) {
                        var z = m._colorSet[q % m._colorSet.length],
                            C = m.lineColor = m.options.lineColor ||
                            z,
                            D = C;
                        b.fillStyle = z;
                        b.strokeStyle = C;
                        ...
                        var A = "solid";
                        if (b.setLineDash) {
                            var x = N(m.nullDataLineDashType, m.lineThickness),
                                A = m.lineDashType,
                                E = N(A, m.lineThickness);
                            b.setLineDash(E)
                        }
                        for (r = !1; q < p.length; q++)
                            if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))
                                if ("number" !== typeof p[q].y) 0 < q && !r && (m.connectNullData ? b.setLineDash && (0 < s.length && (m.options.nullDataLineDashType || !p[q - 1].lineDashType)) &&
                                    (s[s.length - 1].newLineDashArray = x, A = m.nullDataLineDashType) : (d(), s = [])), r = !0;
                                else {
                                    ...
                                    s[s.length] = { x: g, y: r };
                                    q < p.length - 1 && (D !== (p[q].lineColor || C) || A !== (p[q].lineDashType || m.lineDashType)) && (D = p[q].lineColor || C, s[s.length - 1].newStrokeStyle = D, b.setLineDash && (p[q].lineDashType ? (A = p[q].lineDashType, s[s.length -
                                        1].newLineDashArray = N(A, m.lineThickness)) : (A = m.lineDashType, s[s.length - 1].newLineDashArray = E)));
                                    if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < m.markerSize)) {
                                        var aa = m.getMarkerProperties(q, g, r, b);
                                        l.push(aa);
                                        Q = P(Q);
                                        w && l.push({ x: g, y: r, ctx: e, type: aa.type, size: aa.size, color: Q, borderColor: Q, borderThickness: aa.borderThickness })
        ...
        n.prototype.renderStepArea = function(a) {
            ...
            function b() {
                D && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = z : 0 > a.axisY.viewportMaximum ? C = t.y1 : 0 < a.axisY.viewportMinimum && (C = z), f.lineTo(n, C), f.lineTo(D.x, C), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(n, C), l.lineTo(D.x,
                    C), l.closePath(), l.fill()), f.beginPath(), f.moveTo(n, u), l.beginPath(), l.moveTo(n, u), D = { x: n, y: u })
            }
            var e = a.targetCanvasCtx || this.plotArea.ctx,
                f = w ? this._preRenderCtx : e;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (; h < r.length; h++)
                            if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                var Y = u;
                                "number" !== typeof r[h].y ? (g.connectNullData || (c || d) || b(), c = !0) : (n = a.axisX.convertValueToPixel(s), u = a.axisY.convertValueToPixel(r[h].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || Q === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = n, c = u, n = m.x, u = m.y, b(),
        ...
        n.prototype.renderStackedArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    p = [],
                    q = 0,
                    g, r, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var D = a.dataSeriesIndexes[C],
                        ...
                        v = A.dataPoints;
                    A.dataPointIndexes = [];
                    for (q = 0; q < v.length; q++) D = v[q].x.getTime ? v[q].x.getTime() : v[q].x, A.dataPointIndexes[D] = q, e[D] || (m.push(D), e[D] = !0);
                    m.sort(Qa)
                }
                    ...
                    if (0 < m.length) {
                        ...
                        for (var Y = !0, q = 0; q < m.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !Y)))
                                if ("number" !== typeof fa.y) A.connectNullData || (Y || y) || d(), Y = !0;
                                else {
                                    ...
                                    k.push({ x: g, y: n - ma });
                                    h[f] = n - r;
                                    y || Y ? (!y && A.connectNullData ? (b.setLineDash && (A.options.nullDataLineDashType || z === A.lineDashType && A.lineDashType !== A.nullDataLineDashType) && (y = k.pop(), z = k[k.length - 1], d(), b.moveTo(u.x, u.y), k.push(z), k.push(y), z = A.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(g,
                                        r), w && s.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), w && (s.beginPath(), s.moveTo(g, r))), Y = y = !1) : (b.lineTo(g, r), w && s.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && s.moveTo(g, r), k.push({ x: g, y: n - ma })));
                                    u = { x: g, y: r };
                                    q < v.length - 1 && (Q !== (v[q].lineColor || x) || z !== (v[q].lineDashType || A.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({ x: g, y: n - ma }), Q = v[q].lineColor || x, b.strokeStyle = Q, b.setLineDash && (v[q].lineDashType ? (z = v[q].lineDashType, b.setLineDash(N(z, A.lineThickness))) : (z = A.lineDashType, b.setLineDash(E))));
                                    if (0 <= A.dataPointIndexes[f]) {
                                        var F = A.dataPointIds[A.dataPointIndexes[f]];
                                        this._eventManager.objectMap[F] = { id: F, objectType: "dataPoint", dataSeriesIndex: D, dataPointIndex: A.dataPointIndexes[f], x1: g, y1: r }
                                    }
                                    0 <= A.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < A.markerSize) && (ma = A.getMarkerProperties(A.dataPointIndexes[f], g, r, b), l.push(ma), f = P(F), w && l.push({ x: g, y: r, ctx: s, type: ma.type, size: ma.size, color: f, borderColor: f, borderThickness: ma.borderThickness }));
                                    (fa.indexLabel || A.indexLabel || fa.indexLabelFormatter ||
                                        A.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea", dataPoint: fa, dataSeries: A, point: { x: g, y: r }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e })
                                }
                        }
                        d();
                        b.moveTo(g, r);
                ...
                $.drawMarkers(l);
                w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height),
                    this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(t.x1, t.y1, t.width, t.height), s.restore());
                b.restore();
                return { source: c, dest: this.plotArea.ctx, animationCallback: K.xClipAnimation, easingFunction: K.easing.linear, animationBase: 0 }
            }
        };
        n.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    p = [],
                    q = 0,
                    g, r, n, s, u, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var v = a.dataSeriesIndexes[C],
                        ...
                        x = A.dataPoints;
                    A.dataPointIndexes = [];
                    for (q = 0; q < x.length; q++) v = x[q].x.getTime ? x[q].x.getTime() : x[q].x, A.dataPointIndexes[v] = q, e[v] || (m.push(v), e[v] = !0);
                    m.sort(Qa)
                }
                for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if (0 < m.length) {
                        var e = A._colorSet[q %
                                A._colorSet.length],
                            E = A.lineColor = A.options.lineColor || e,
                            Q = E;
                        b.fillStyle = e;
                        b.strokeStyle = E;
                        ...
                        for (var Y = !0, q = 0; q < m.length; q++) {
                            var f = m[q],
                                fa = null,
                                fa = 0 <= A.dataPointIndexes[f] ? x[A.dataPointIndexes[f]] : { x: f, y: null };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !Y)))
                                if ("number" !== typeof fa.y) A.connectNullData ||
                                    (Y || s) || d(), Y = !0;
                                else {
                                    var ma;
                                    ...
                                    k.push({ x: g, y: y - ba });
                                    h[f] = y - r;
                                    s || Y ? (!s && A.connectNullData ? (b.setLineDash && (A.options.nullDataLineDashType || u === A.lineDashType &&
                                        A.lineDashType !== A.nullDataLineDashType) && (s = k.pop(), u = k[k.length - 1], d(), b.moveTo(n.x, n.y), k.push(u), k.push(s), u = A.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(g, r), w && z.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), w && (z.beginPath(), z.moveTo(g, r))), Y = s = !1) : (b.lineTo(g, r), w && z.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && z.moveTo(g, r), k.push({ x: g, y: y - ba })));
                                    n = { x: g, y: r };
                                    q < x.length - 1 && (Q !== (x[q].lineColor || E) || u !== (x[q].lineDashType || A.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({
                                        x: g,
                                        y: y -
                                            ba
                                    }), Q = x[q].lineColor || E, b.strokeStyle = Q, b.setLineDash && (x[q].lineDashType ? (u = x[q].lineDashType, b.setLineDash(N(u, A.lineThickness))) : (u = A.lineDashType, b.setLineDash(F))));
                                    if (0 <= A.dataPointIndexes[f]) {
                                        var G = A.dataPointIds[A.dataPointIndexes[f]];
                                        this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: v, dataPointIndex: A.dataPointIndexes[f], x1: g, y1: r }
                                    }
                                    0 <= A.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < A.markerSize) && (ba = A.getMarkerProperties(q, g, r, b), t.push(ba), f = P(G),
                                        w && t.push({ x: g, y: r, ctx: z, type: ba.type, size: ba.size, color: f, borderColor: f, borderThickness: ba.borderThickness }));
                                    (fa.indexLabel || A.indexLabel || fa.indexLabelFormatter || A.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: fa, dataSeries: A, point: { x: g, y: r }, direction: 0 > x[q].y === a.axisY.reversed ? 1 : -1, color: e })
                                }
                        }
                        d();
                        b.moveTo(g, r);
        ...
        n.prototype.renderBubble = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
                    for (var m = a.dataSeriesIndexes[k], p = this.data[m], q = p.dataPoints,
                            g = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (g = q[e].z, g > t && (t = g), g < h && (h = g));
                for (var r = 25 * Math.PI, n = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, r), k = 0; k < a.dataSeriesIndexes.length; k++)
                    if (m = a.dataSeriesIndexes[k], p = this.data[m], q = p.dataPoints, 0 < q.length)
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                ...
                                var g = q[e].z,
                                    s = 2 * Math.max(Math.sqrt((t === h ? n / 2 : r + (n - r) / (t - h) * (g - h)) / Math.PI) << 0, 1),
                                ...
                                this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: e, x1: f, y1: l, size: s };
                                s = P(u);
                                w && $.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, s, s, g.borderThickness);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var v = a.dataSeriesIndexes[n],
                        ...
                        y = u.dataPoints;
                    if (0 < y.length)
                        for (var z = 5 < r && u.bevelEnabled ? !0 : !1, t = 0; t < y.length; t++)
                            if (y[t].getTime ? g = y[t].x.getTime() : g = y[t].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(y[t].y) && y[t].y.length && "number" === typeof y[t].y[0] &&
                                ...
                                var C = h - r / 2 << 0,
                                    ...
                                    x = 0 === A % 2 ? 0 : 0.5,
                                    E = u.dataPointIds[t];
                                this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: v, dataPointIndex: t, x1: C, y1: k, x2: D, y2: m, x3: h, y3: p, x4: h, y4: q, borderThickness: A, color: e };
                                c.strokeStyle = e;
                                c.beginPath();
                                c.lineWidth = A;
                                b.lineWidth = Math.max(A, 4);
                                "candlestick" === u.type ? (c.moveTo(h - x, m), c.lineTo(h - x, Math.min(k, q)), c.stroke(), c.moveTo(h - x, Math.max(k, q)), c.lineTo(h - x, p), c.stroke(), ea(c, C, Math.min(k, q), D, Math.max(k, q), y[t].y[0] <= y[t].y[3] ? u.risingColor : f, A, e, z, z, !1, !1, u.fillOpacity), w && (e = P(E), b.strokeStyle = e, b.moveTo(h - x, m), b.lineTo(h - x, Math.min(k,
                                    q)), b.stroke(), b.moveTo(h - x, Math.max(k, q)), b.lineTo(h - x, p), b.stroke(), ea(b, C, Math.min(k, q), D, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(h - x, m), c.lineTo(h - x, p), c.stroke(), c.beginPath(), c.moveTo(h, k), c.lineTo(C, k), c.stroke(), c.beginPath(), c.moveTo(h, q), c.lineTo(D, q), c.stroke(), w && (e = P(E), b.strokeStyle = e, b.moveTo(h - x, m), b.lineTo(h - x, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(C, k), b.stroke(), b.beginPath(), b.moveTo(h, q), b.lineTo(D, q), b.stroke()));
                                (y[t].indexLabel || u.indexLabel ||
                                    y[t].indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({ chartType: u.type, dataPoint: y[t], dataSeries: u, point: { x: C + (D - C) / 2, y: a.axisY.reversed ? p : m }, direction: 1, bounds: { x1: C, y1: Math.min(m, p), x2: D, y2: Math.max(m, p) }, color: e })
                            }
                }
        ...
        n.prototype.renderBoxAndWhisker = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = !1, n = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var u = a.dataSeriesIndexes[v],
                        y = this.data[u],
                        z = y.dataPoints;
                    if (0 < z.length)
                        for (var C = 5 < r && y.bevelEnabled ? !0 : !1, l = 0; l < z.length; l++)
                            if (z[l].getTime ? g = z[l].x.getTime() : g = z[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(z[l].y) && z[l].y.length && "number" === typeof z[l].y[0] && "number" === typeof z[l].y[1] && "number" === typeof z[l].y[2] && "number" === typeof z[l].y[3] && "number" === typeof z[l].y[4] && 5 === z[l].y.length) {
                                ...
                                m = a.axisY.convertValueToPixel(z[l].y[2]);
                                p = a.axisY.convertValueToPixel(z[l].y[3]);
                                q = a.axisY.convertValueToPixel(z[l].y[4]);
                                var D = t - r / 2 << 0,
                                    A = t + r / 2 << 0,
                                    e = z[l].color ? z[l].color : y._colorSet[0],
                                    x = Math.round(Math.max(1, 0.15 * r)),
                                    E = 0 === x % 2 ? 0 : 0.5,
                                    Q = z[l].whiskerColor ? z[l].whiskerColor : z[l].color ? y.whiskerColor ? y.whiskerColor : z[l].color : y.whiskerColor ? y.whiskerColor : e,
                                    aa = "number" === typeof z[l].whiskerThickness ? z[l].whiskerThickness : "number" === typeof y.options.whiskerThickness ? y.whiskerThickness : x,
                                    F = z[l].whiskerDashType ? z[l].whiskerDashType : y.whiskerDashType,
                                    Y = s(z[l].whiskerLength) ? s(y.options.whiskerLength) ? r : y.whiskerLength : z[l].whiskerLength,
                                    Y = "number" === typeof Y ? 0 >= Y ? 0 : Y >= r ? r : Y : "string" === typeof Y ? parseInt(Y) * r / 100 > r ? r : parseInt(Y) * r / 100 : r,
                                    fa = 1 === Math.round(aa) % 2 ? 0.5 : 0,
                                    ma = z[l].stemColor ? z[l].stemColor : z[l].color ? y.stemColor ? y.stemColor : z[l].color : y.stemColor ? y.stemColor : e,
                                    ba = "number" === typeof z[l].stemThickness ? z[l].stemThickness : "number" === typeof y.options.stemThickness ? y.stemThickness : x,
                                    G = 1 === Math.round(ba) % 2 ? 0.5 : 0,
                                    J = z[l].stemDashType ? z[l].stemDashType :
                                    y.stemDashType,
                                    H = z[l].lineColor ? z[l].lineColor : z[l].color ? y.lineColor ? y.lineColor : z[l].color : y.lineColor ? y.lineColor : e,
                                    M = "number" === typeof z[l].lineThickness ? z[l].lineThickness : "number" === typeof y.options.lineThickness ? y.lineThickness : x,
                                    S = z[l].lineDashType ? z[l].lineDashType : y.lineDashType,
                                    L = 1 === Math.round(M) % 2 ? 0.5 : 0,
                                    R = y.upperBoxColor,
                                    xa = y.lowerBoxColor,
                                    sa = s(y.options.fillOpacity) ? 1 : y.fillOpacity,
                                    O = y.dataPointIds[l];
                                ...
                                c.save();
                                0 < ba && (c.beginPath(), c.strokeStyle = ma, c.lineWidth = ba, c.setLineDash && c.setLineDash(N(J, ba)), c.moveTo(t - G, k), c.lineTo(t - G, h), c.stroke(), c.moveTo(t - G, p), c.lineTo(t - G, m), c.stroke());
                                c.restore();
                                b.lineWidth = Math.max(x, 4);
                                c.beginPath();
                                ea(c, D, Math.min(q, k), A, Math.max(k, q), xa, 0, e, n ? C : !1, n ? !1 : C, !1, !1, sa);
                                c.beginPath();
                                ea(c, D, Math.min(m, q), A, Math.max(q, m), R, 0, e, n ? !1 : C, n ? C : !1, !1, !1, sa);
                                c.beginPath();
                                c.lineWidth = x;
                                c.strokeStyle = e;
                                c.rect(D - E, Math.min(k, m) - E, A - D + 2 * E, Math.max(k, m) - Math.min(k, m) + 2 * E);
                                c.stroke();
                                c.save();
                                0 < M && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(N(S, M)), c.strokeStyle = H, c.lineWidth = M, c.moveTo(D, q - L), c.lineTo(A, q - L), c.stroke());
                                c.restore();
                                c.save();
                                0 < aa && (c.beginPath(), c.setLineDash && c.setLineDash(N(F, aa)), c.strokeStyle = Q, c.lineWidth = aa, c.moveTo(t - Y / 2 << 0, p - fa), c.lineTo(t + Y / 2 << 0, p -
                                    fa), c.stroke(), c.moveTo(t - Y / 2 << 0, h + fa), c.lineTo(t + Y / 2 << 0, h + fa), c.stroke());
                                c.restore();
                                w && (e = P(O), b.strokeStyle = e, b.lineWidth = ba, 0 < ba && (b.moveTo(t - E - G, k), b.lineTo(t - E - G, Math.max(h, p)), b.stroke(), b.moveTo(t - E - G, Math.min(h, p)), b.lineTo(t - E - G, m), b.stroke()), ea(b, D, Math.max(k, m), A, Math.min(k, m), e, 0, null, !1, !1, !1, !1), 0 < aa && (b.beginPath(), b.lineWidth = aa, b.moveTo(t + Y / 2, p - fa), b.lineTo(t - Y / 2, p - fa), b.stroke(), b.moveTo(t + Y / 2, h + fa), b.lineTo(t - Y / 2, h + fa), b.stroke()));
                                (z[l].indexLabel || y.indexLabel || z[l].indexLabelFormatter ||
                                    y.indexLabelFormatter) && this._indexLabels.push({ chartType: y.type, dataPoint: z[l], dataSeries: y, point: { x: D + (A - D) / 2, y: a.axisY.reversed ? h : p }, direction: 1, bounds: { x1: D, y1: Math.min(h, p), x2: A, y2: Math.max(h, p) }, color: e })
                            }
                }
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                    ...
                    if (0 < g.length)
                        for (var r =
                            ...
                            if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                                ...
                                u = q.dataPointIds[f];
                                this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: f, x1: n, y1: l, x2: v, y2: t };
                                ea(c, n, l, v, t, b, 0, b, r, r, !1, !1, q.fillOpacity);
                                b = P(u);
                                w && ea(this._eventManager.ghostCtx, n, l, v, t, b, 0, null, !1, !1, !1, !1);
                                if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "rangeColumn",
                                    dataPoint: g[f],
                                    dataSeries: q,
                                    indexKeyword: 0,
                                    point: { x: n + (v - n) / 2, y: g[f].y[1] >= g[f].y[0] ? t : l },
                                    direction: g[f].y[1] >= g[f].y[0] ? -1 : 1,
                                    bounds: { x1: n, y1: Math.min(l, t), x2: v, y2: Math.max(l, t) },
                                    color: b
                                }), this._indexLabels.push({ chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 1, point: { x: n + (v - n) / 2, y: g[f].y[1] >= g[f].y[0] ? l : t }, direction: g[f].y[1] >= g[f].y[0] ? 1 : -1, bounds: { x1: n, y1: Math.min(l, t), x2: v, y2: Math.max(l, t) }, color: b })
                            }
                }
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                        var z = a.dataSeriesIndexes[y],
                            C = this.data[z],
                            D = C.dataPoints,
                            A = s(C._linkedSeries) ? !1 : C._linkedSeries.type.match(/(bar|column)/ig) && C._linkedSeries.visible ? !0 : !1,
                            E = 0;
                        if (A)
                            for (e = C._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) ||
                                !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && E || (this.data[u].type.match(/(range)/ig) && (f = !0), E++);
                        ...
                        f && (t = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
                            b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (A ? v : 1))) << 0 : 0.03 * this.width);
                        u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range)) / (A ? v : 1)) << 0;
                        ...
                        if (0 < D.length)
                            for (var F = C._colorSet, t = 0; t < D.length; t++) {
                                ...
                                if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(D[t].y) && D[t].y.length && "number" === typeof D[t].y[0] && "number" === typeof D[t].y[1]) {
                                    ...
                                    b ? p = ja : g = ja;
                                    b ? (q = a.axisX.reversed ? k + (A ?
                                        v : 1) * u / 2 - (A ? E - 1 : 0) * u << 0 : k - (A ? v : 1) * u / 2 + (A ? E - 1 : 0) * u << 0, g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (m = a.axisX.reversed ? h + (A ? v : 1) * u / 2 - (A ? E - 1 : 0) * u << 0 : h - (A ? v : 1) * u / 2 + (A ? E - 1 : 0) * u << 0, p = a.axisX.reversed ? m - u << 0 : m + u << 0);
                                    !b && q > g && (ja = q, q = g, g = ja);
                                    b && m > p && (ja = m, m = p, p = ja);
                                    ja = C.dataPointIds[t];
                                    this._eventManager.objectMap[ja] = { id: ja, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: t, x1: Math.min(m, p), y1: Math.min(q, g), x2: Math.max(p, m), y2: Math.max(g, q), isXYSwapped: b, stemProperties: aa, whiskerProperties: Q };
                                    x(c, Math.min(m,
                                        p), Math.min(q, g), Math.max(p, m), Math.max(g, q), e, Q, aa, b);
                                    w && x(this._eventManager.ghostCtx, m, q, p, g, e, Q, aa, b);
                                    if (D[t].indexLabel || C.indexLabel || D[t].indexLabelFormatter || C.indexLabelFormatter) this._indexLabels.push({ chartType: "error", dataPoint: D[t], dataSeries: C, indexKeyword: 0, point: { x: b ? D[t].y[1] >= D[t].y[0] ? m : p : m + (p - m) / 2, y: b ? q + (g - q) / 2 : D[t].y[1] >= D[t].y[0] ? g : q }, direction: D[t].y[1] >= D[t].y[0] ? -1 : 1, bounds: { x1: b ? Math.min(m, p) : m, y1: b ? q : Math.min(q, g), x2: b ? Math.max(m, p) : p, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b }),
                                        this._indexLabels.push({ chartType: "error", dataPoint: D[t], dataSeries: C, indexKeyword: 1, point: { x: b ? D[t].y[1] >= D[t].y[0] ? p : m : m + (p - m) / 2, y: b ? q + (g - q) / 2 : D[t].y[1] >= D[t].y[0] ? q : g }, direction: D[t].y[1] >= D[t].y[0] ? 1 : -1, bounds: { x1: b ? Math.min(m, p) : m, y1: b ? q : Math.min(q, g), x2: b ? Math.max(m, p) : p, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b })
                                }
                            }
                    }
        ...
        n.prototype.renderRangeBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                m = this.options.dataPointWidth ? this.dataPointWidth : 0.9 *
                    (e.height * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
                this.dataPointMaxWidth && f > l && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l));
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if (r[f].getTime ? k = r[f].x.getTime() : k = r[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(r[f].y) && r[f].y.length && "number" === typeof r[f].y[0] && "number" === typeof r[f].y[1]) {
                                ...
                                l > t && (b = l, l = t, t = b);
                                b = r[f].color ? r[f].color : g._colorSet[f % g._colorSet.length];
                                ea(c, l, h, t, v, b, 0, null, n, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = P(b);
                                w && ea(this._eventManager.ghostCtx, l, h, t, v, b, 0, null, !1, !1, !1, !1);
                                if (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: r[f], dataSeries: g, indexKeyword: 0, point: { x: r[f].y[1] >= r[f].y[0] ? l : t, y: h + (v - h) / 2 }, direction: r[f].y[1] >= r[f].y[0] ? -1 : 1, bounds: { x1: Math.min(l, t), y1: h, x2: Math.max(l, t), y2: v }, color: b }), this._indexLabels.push({
                                    chartType: "rangeBar",
                                    dataPoint: r[f],
                                    dataSeries: g,
                                    indexKeyword: 1,
                                    ...
                                    bounds: { x1: Math.min(l, t), y1: h, x2: Math.max(l, t), y2: v },
                                    color: b
                                })
                            }
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    var f = [],
                        ...
                        r, n, s, u, y = null;
                    if (0 < p.length) {
                        var z = m._colorSet[g % m._colorSet.length],
                            v = m.lineColor = m.options.lineColor || z,
                            D = v;
                        b.fillStyle = z;
                        b.strokeStyle = v;
                        b.lineWidth = m.lineThickness;
                        ...
                        for (var Q = !0; g < p.length; g++)
                            if (u = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !Q)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || Q ? (m.connectNullData && !q ? (b.setLineDash && (m.options.nullDataLineDashType || A === m.lineDashType &&
                                        m.lineDashType !== m.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = E, A = m.nullDataLineDashType, b.setLineDash(x)), b.lineTo(r, n), w && e.lineTo(r, n), h.push({ x: r, y1: n, y2: s })) : (b.beginPath(), b.moveTo(r, n), y = { x: r, y: n }, h = [], h.push({ x: r, y1: n, y2: s }), w && (e.beginPath(), e.moveTo(r, n))), Q = q = !1) : (b.lineTo(r, n), h.push({ x: r, y1: n, y2: s }), w && e.lineTo(r, n), 0 == g % 250 && d());
                                    u = m.dataPointIds[g];
                                    this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: r, y1: n, y2: s };
                                    g < p.length -
                                        1 && (D !== (p[g].lineColor || v) || A !== (p[g].lineDashType || m.lineDashType)) && (d(), D = p[g].lineColor || v, h[h.length - 1].newStrokeStyle = D, b.strokeStyle = D, b.setLineDash && (p[g].lineDashType ? (A = p[g].lineDashType, h[h.length - 1].newLineDashArray = N(A, m.lineThickness), b.setLineDash(h[h.length - 1].newLineDashArray)) : (A = m.lineDashType, h[h.length - 1].newLineDashArray = E, b.setLineDash(E))));
                                    if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < m.markerSize)) {
                                        ...
                                        f.push(aa);
                                        F = P(u);
                                        w && f.push({ x: r, y: n, ctx: e, type: aa.type, size: aa.size, color: F, borderColor: F, borderThickness: aa.borderThickness })
                                    }
                                    if (p[g].indexLabel || m.indexLabel || p[g].indexLabelFormatter || m.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: m, indexKeyword: 0, point: { x: r, y: n }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? -1 : 1, color: z }),
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: m, indexKeyword: 1, point: { x: r, y: s }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? 1 : -1, color: z })
                                } else Q || q || d(), Q = !0;
                        d();
                        $.drawMarkers(f)
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var n = a.dataSeriesIndexes[h],
                        ...
                        m = k.dataPoints,
                        f = k.id;
                    this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: n };
                    f = P(f);
                    e.fillStyle = f;
                    var f = [],
                        p = 0,
                    ...
                    if (0 < m.length) {
                        ...
                        var C = "solid",
                            D;
                        if (b.setLineDash) {
                            var A = N(k.nullDataLineDashType, k.lineThickness),
                                C = k.lineDashType;
                            D = N(C, k.lineThickness)
                        }
                        for (g = !1; p < m.length; p++)
                            if (q = m[p].x.getTime ? m[p].x.getTime() : m[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                                    !g)))
                                if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                                    ...
                                    this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: p, x1: q, y1: g, y2: r };
                                    s[s.length] = { x: q, y: g };
                                    x[x.length] = { x: q, y: r };
                                    p < m.length - 1 && (z !== (m[p].lineColor || y) || C !== (m[p].lineDashType || k.lineDashType)) && (z = m[p].lineColor || y, s[s.length -
                                        1].newStrokeStyle = z, b.setLineDash && (m[p].lineDashType ? (C = m[p].lineDashType, s[s.length - 1].newLineDashArray = N(C, k.lineThickness)) : (C = k.lineDashType, s[s.length - 1].newLineDashArray = D)));
                                    if (0 !== m[p].markerSize && (0 < m[p].markerSize || 0 < k.markerSize)) {
                                        var F = k.getMarkerProperties(p, q, g, b);
                                        f.push(F);
                                        var Q = P(E);
                                        w && f.push({ x: q, y: g, ctx: e, type: F.type, size: F.size, color: Q, borderColor: Q, borderThickness: F.borderThickness });
                                    ...
                                    if (m[p].indexLabel || k.indexLabel || m[p].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: m[p], dataSeries: k, indexKeyword: 0, point: { x: q, y: g }, direction: m[p].y[0] <= m[p].y[1] ? -1 : 1, color: u }), this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: m[p], dataSeries: k, indexKeyword: 1, point: { x: q, y: r }, direction: m[p].y[0] <= m[p].y[1] ? 1 : -1, color: u });
                                    g = !1
                                } else 0 < p && !g && (k.connectNullData ? b.setLineDash &&
                                    (0 < s.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = A, C = k.nullDataLineDashType) : (d(D, y), s = [], x = [])), g = !0;
                        d(D, y);
                        $.drawMarkers(f)
                    }
                }
        ...
        n.prototype.renderWaterfall = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx,
                    ...
                    f = this.plotArea,
                    l = 0,
                    h, n, k, m, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                ...
                this.dataPointMaxWidth && l > n && (l = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n));
                !this.dataPointMaxWidth && (this.dataPointMinWidth && n < l) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, l));
                q < l && (q = l);
                q > n && (q = n);
                c.save();
                w && this._eventManager.ghostCtx.save();
                ...
                c.rect(f.x1, f.y1, f.width, f.height);
                c.clip();
                w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(f.x1,
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < v.length)
                        for (var z = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, x = null, A = null, l = 0; l < v.length; l++)
                            if (v[l].getTime ?
                                m = v[l].x.getTime() : m = v[l].x, "number" !== typeof v[l].y) {
                                if (0 < l && !C && s.connectNullData) var E = s.options.nullDataLineDashType || !v[l - 1].lineDashType ? s.nullDataLineDashType : v[l - 1].lineDashType;
                                C = !0
                            } else {
                                h = a.axisX.convertValueToPixel(m);
                                n = 0 === s.dataPointEOs[l].cumulativeSum ? p : a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);
                                ...
                                e = s.dataPointIds[l];
                                this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: l, x1: h, y1: n, x2: F, y2: k };
                                var Q = v[l].color ? v[l].color : 0 < v[l].y ? s.risingColor : s.fallingColor;
                                ea(c, h, n, F, k, Q, 0, Q, z, z, !1, !1, s.fillOpacity);
                                e = P(e);
                                w && ea(this._eventManager.ghostCtx, h, n, F, k, e, 0, null, !1, !1, !1, !1);
                                var aa, Q = h;
                                aa = "undefined" !== typeof v[l].isIntermediateSum && !0 === v[l].isIntermediateSum || "undefined" !== typeof v[l].isCumulativeSum && !0 === v[l].isCumulativeSum ? 0 < v[l].y ? n : k : 0 < v[l].y ? k : n;
                                0 < l && x && (!C || s.connectNullData) && (C && c.setLineDash && c.setLineDash(N(E, u)), c.beginPath(), c.moveTo(x, A - y), c.lineTo(Q, aa - y), 0 < u && c.stroke(), w && (b.beginPath(), b.moveTo(x, A - y), b.lineTo(Q, aa - y), 0 < u && b.stroke()));
                                C = !1;
                                x = F;
                                A = 0 < v[l].y ? n : k;
                                Q = v[l].lineDashType ? v[l].lineDashType : s.options.lineDashType ? s.options.lineDashType :
                                    "shortDash";
                                c.strokeStyle = v[l].lineColor ? v[l].lineColor : s.options.lineColor ? s.options.lineColor : "#9e9e9e";
                                c.lineWidth = u;
                                c.setLineDash && (Q = N(Q, u), c.setLineDash(Q));
                                (v[l].indexLabel || s.indexLabel || v[l].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({ chartType: "waterfall", dataPoint: v[l], dataSeries: s, point: { x: h + (F - h) / 2, y: 0 <= v[l].y ? n : k }, direction: 0 > v[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: h, y1: Math.min(n, k), x2: F, y2: Math.max(n, k) }, color: e })
                            }
                }
        ...
        var ha = function(a, d, c, b, e, f, l, h, n) {
            if (!(0 > c)) {
                ...
                a.save();
                a.globalAlpha = h;
                "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, l, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, l, !1), 0 <= n && a.arc(d.x, d.y, n * c, l, f, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth =
                    2, a.fill());
                a.globalAlpha = 1;
                a.restore()
            }
        ...
        n.prototype.renderPie = function(a) {
            function d() {
                if (k && m) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
                        ...
                        if (k.indexLabelFormatter || f.indexLabelFormatter) t = { chart: n.options, dataSeries: k, dataPoint: f, total: p.total, percent: p.percent };
                        p = f.indexLabelFormatter ? f.indexLabelFormatter(t) :
                            f.indexLabel ? n.replaceKeywordsWithValue(f.indexLabel, f, k, e) : k.indexLabelFormatter ? k.indexLabelFormatter(t) : k.indexLabel ? n.replaceKeywordsWithValue(k.indexLabel, f, k, e) : f.label ? f.label : "";
                    ...
                    l = f = 0;
                    p = !1;
                    for (e = 0; e < m.length; e++) h = g[(c + e) % m.length], 1 < a && (h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !p ? (h.hemisphere = "right", f++) : (h.hemisphere = "left", p = !0));
                    p = !1;
            ...
            function c(a) {
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * A * Math.cos(g[b].midAngle),
                            ...
                            l = !1;
                        if (m[b].exploded) { if (1E-9 < Math.abs(g[b].center.x - (z.x + e)) || 1E-9 < Math.abs(g[b].center.y - (z.y + f))) g[b].center.x = z.x + e * a, g[b].center.y = z.y + f * a, l = !0 } else if (0 < Math.abs(g[b].center.x - z.x) || 0 < Math.abs(g[b].center.y - z.y)) g[b].center.x = z.x + e * (1 - a), g[b].center.y = z.y + f * (1 - a),
                            l = !0;
                        l && (e = {}, e.dataSeries = k, e.dataPoint = k.dataPoints[b], e.index = b, n.toolTip.highlightObjects([e]));
                        ha(n.plotArea.ctx, g[b].center, g[b].radius, m[b].color ? m[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, g[b].percentInnerRadius)
                    }
                }
                a = n.plotArea.ctx;
                a.save();
                ...
                a.lineJoin = "round";
                for (b = b = 0; b < m.length; b++) c = g[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !==
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < m.length) {
                    ...
                    k = 0;
                    k = "right" === p.hemisphere ? z.x + Math.sqrt(Math.pow(w, 2) - Math.pow(c - z.y, 2)) : z.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - z.y, 2));
                    t = z.x + A * Math.cos(p.midAngle);
                    q = z.y + A * Math.sin(p.midAngle);
                    ...
                    q = e(a);
                    h = k = 0;
                    0 > c ? (h = "right" === p.hemisphere ? t : q, l = c, null !== h && (t = -c, c = p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - (g[h].indexLabelTextBlock.y + g[h].indexLabelTextBlock.height / 2), c - t < r && (k = -t, h = f(h, k, d + 1), +h.toFixed(y) > +k.toFixed(y) && (l = c > r ? -(c - r) : -(t - (h - k)))))) : 0 < c && (h = "right" === p.hemisphere ?
                        q : t, l = c, null !== h && (t = c, c = g[h].indexLabelTextBlock.y - g[h].indexLabelTextBlock.height / 2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2), c - t < r && (k = t, h = f(h, k, d + 1), +h.toFixed(y) < +k.toFixed(y) && (l = c > r ? c - r : t - (k - h)))));
                    l && (d = p.indexLabelTextBlock.y + l, c = 0, c = "right" === p.hemisphere ? z.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - z.y, 2)) : z.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - z.y, 2)), p.midAngle > Math.PI / 2 - u && p.midAngle < Math.PI / 2 + u ? (k = (a - 1 + g.length) % g.length, k = g[k], a = g[(a + 1 + g.length) % g.length], "left" === p.hemisphere &&
            ...
            function l() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && A - d <= E) l = !1;
                    l && (A -= d);
                    d = 0;
                    if ("inside" !== k.indexLabelPlacement) {
                        ...
                        for (a = 0; a < m.length; a++) {
                            var h =
                                g[a];
                            h.indexLabelTextBlock.x = z.x + w * Math.cos(h.midAngle);
                            h.indexLabelTextBlock.y = z.y + w * Math.sin(h.midAngle);
                        ...
                        for (var t, s, a = 0; a < m.length; a++) {
                            ...
                            if (null !== u) {
                                ...
                                var C = 0,
                                    C = b(t, s) - r;
                                if (0 > C) {
                                    for (var x = s = 0, D = 0; D < m.length; D++) D !== a && g[D].hemisphere === h.hemisphere && (g[D].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? s++ : x++);
                                    s = C / (s + x || 1) * x;
                                    var x = -1 * (C - s),
                                        J = D = 0;
                                    "right" === h.hemisphere ? (D = f(a, s), x = -1 * (C - D), J = f(u, x), +J.toFixed(y) <
                                        +x.toFixed(y) && +D.toFixed(y) <= +s.toFixed(y) && f(a, -(x - J))) : (D = f(u, s), x = -1 * (C - D), J = f(a, x), +J.toFixed(y) < +x.toFixed(y) && +D.toFixed(y) <= +s.toFixed(y) && f(u, -(x - J)))
                                }
                            }
                        }
                    } else
                        for (a = 0; a < m.length; a++) h = g[a], w = "pie" === k.type ? 0.7 * A : 0.8 * A, u = z.x + w * Math.cos(h.midAngle), s = z.y + w * Math.sin(h.midAngle), h.indexLabelTextBlock.x = u, h.indexLabelTextBlock.y = s;
                    for (a = 0; a < m.length; a++)
                            ...
                            if (f = !1, t = g[k], t.indexLabelText) {
                                ...
                                if (null !== l) {
                                    ...
                                    if (q = 0 > C) {
                                        ...
                                        var n = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height /
                                            2,
                                        ...
                                        q = t.indexLabelTextBlock.x + t.indexLabelTextBlock.width < h.indexLabelTextBlock.x - p || q > u + p || n > B + p || r < s - p ? !1 : !0
                                    }
                                    q ? (0 > a && (a = k), l !== a && (c = l, d += -C), 0 === k % Math.max(m.length / 10, 3) && (f = !0)) : f = !0;
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k =
                    ...
                    C = 0;
                a = !1;
                for (var x = 0; x < m.length; x++) C += Math.abs(m[x].y), !a && ("undefined" !== typeof m[x].indexLabel && null !== m[x].indexLabel && 0 < m[x].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof m[x].label && null !== m[x].label && 0 < m[x].label.toString().length) && (a = !0);
                if (0 !== C) {
                    ...
                    k.radius && (A = Sa(k.radius, A));
                    var E = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Sa(k.innerRadius, A) : 0.7 * A;
                    k.radius = A;
                    "doughnut" === k.type && (k.innerRadius = E);
                    var F = Math.min(E / A, (A - 1) / A);
                    this.pieDoughnutClickHandler = function(a) {
                        n.isAnimating || !s(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && n._animator.animate(0,
                            500,
                            function(a) {
                                c(a);
                                h();
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                        ...
                        for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < m.length; c++) {
                            ...
                            e > d && ha(n.plotArea.ctx, g[c].center, g[c].radius, l, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius);
                            if (f) break
                        }
                        h();
                        n.dispatchEvent("dataAnimationIterationEnd", { chart: n });
        ...
        n.prototype.renderFunnel =
            function(a) {
                ...
                function c() {
                    ...
                    if (0 ===
                        g) return -1;
                    for (var l = d[0] = 0, h = 0, m, p, b = b - a, l = !1, k = 0; k < y.length; k++) a = Math.abs(y[k].y) * f / g, l ? m = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = V * V * b * b - 4 * Math.abs(V) * a, 0 > p ? (p = c, l = (b + p) * (e - h) / 2, a -= l, m = e - h, h += e - h, m += 0 == p ? 0 : a / p, h += a / p, l = !0) : (m = (Math.abs(V) * b - Math.sqrt(p)) / 2, p = b - 2 * m / Math.abs(V), h += m, h > e && (h -= m, p = c, l = (b + p) * (e - h) / 2, a -= l, m = e - h, h += e - h, m += a / p, h += a / p, l = !0), b = p)), d.push(m);
                    return d
                }

                function b() {
                    if (u && y) {
                        for (var a, b, c, d, e, f, k, l, h, m, p, q, t, n, r, B = [], v = [], z = { percent: null, total: null }, C = null, A = 0; A < y.length; A++) r = O[A],
                            r = "undefined" !== typeof r.x5 ? (r.y2 + r.y4) / 2 : (r.y2 + r.y3) / 2, r = g(r).x2 + 1, B[A] = M - r - U;
                        r = 0.5 * U;
                        for (var A = 0, D = y.length - 1; A < y.length || 0 <= D; A++, D--) {
                            b = u.reversed ? y[D] : y[A];
                            a = b.color ? b.color : u.reversed ? u._colorSet[(y.length - 1 - A) % u._colorSet.length] : u._colorSet[A % u._colorSet.length];
                            ...
                            t = u.dataPointIds[A];
                            x._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataPointIndex: A, dataSeriesIndex: 0, funnelSection: O[u.reversed ? y.length - 1 - A : A] };
                            ...
                            if (t > B[A] || 0 > t) t = B[A];
                            v[A] = "inside" === u.indexLabelPlacement ? O[A].height : !1;
                            z = x.getPercentAndTotal(u, b);
                            if (u.indexLabelFormatter || b.indexLabelFormatter) C = { chart: x.options, dataSeries: u, dataPoint: b, total: z.total, percent: z.percent };
                            ...
                            R.roundRect || Ca(R);
                            c = new ia(R, { fontSize: f, fontFamily: l, fontColor: e, fontStyle: k, fontWeight: h, horizontalAlign: c, textAlign: n, backgroundColor: d, maxWidth: t, maxHeight: !1 === v[A] ? q ? 4.28571429 * f : 1.5 * f : v[A], text: b, padding: da });
                            c.measureText();
                            I.push({ textBlock: c, id: u.reversed ? D : A, isDirty: !1, lineColor: a, lineThickness: m, lineDashType: p, height: c.height < c.maxHeight ? c.height : c.maxHeight, width: c.width < c.maxWidth ? c.width : c.maxWidth })
                        }
                    }
                }
                ...
                function e() {
                    ...
                    e = !1;
                    c = 0;
                    for (var g, k = M - T - U / 2, k = u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth > k ? k : u.indexLabelMaxWidth : k, l = I.length - 1; 0 <= l; l--) {
                        g = y[I[l].id];
                        c = I[l];
                        d = c.textBlock;
                    ...
                    if (e)
                        for (l = I.length - 1; 0 <= l; l--) a = O[l], I[l].textBlock.maxWidth = f[f.length - (l + 1)], I[l].textBlock.measureText(), I[l].textBlock.x = M - k, c = I[l].textBlock.height < I[l].textBlock.maxHeight ? I[l].textBlock.height :
                            I[l].textBlock.maxHeight, e = I[l].textBlock.width < I[l].textBlock.maxWidth ? I[l].textBlock.width : I[l].textBlock.maxWidth, I[l].height = c, I[l].width = e, c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, I[l].textBlock.y = c - I[l].height / 2, u.reversed ? (I[l].textBlock.y + I[l].height > na + C && (I[l].textBlock.y = na + C - I[l].height), I[l].textBlock.y < sa - C && (I[l].textBlock.y = sa - C)) : (I[l].textBlock.y < na - C && (I[l].textBlock.y = na - C), I[l].textBlock.y + I[l].height > sa + C && (I[l].textBlock.y = sa + C - I[l].height))
                }
                ...
                function f() {
                    ...
                    if ("inside" !== u.indexLabelPlacement)
                        for (var e = 0; e < O.length; e++) 0 == I[e].textBlock.text.length ? I[e].isDirty = !0 : (a = O[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c > xa ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < xa ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, I[e].textBlock.x = b + U, I[e].textBlock.y = c - I[e].height / 2, u.reversed ? (I[e].textBlock.y + I[e].height > na + C && (I[e].textBlock.y = na + C - I[e].height), I[e].textBlock.y < sa - C && (I[e].textBlock.y =
                            sa - C)) : (I[e].textBlock.y < na - C && (I[e].textBlock.y = na - C), I[e].textBlock.y + I[e].height > sa + C && (I[e].textBlock.y = sa + C - I[e].height)));
                    else
                ...
                function l() {
                    ...
                    for (var d, e, f, g, k, l, m = 1, n = 0; n < 2 * m; n++) {
                ...
                function h(a, b) { return (b < O.length ? I[b].textBlock.y : u.reversed ? na + C : sa + C) - (0 > a ? u.reversed ? sa - C : na - C : I[a].textBlock.y + I[a].height + da) }

                function n(a, b, c) {
                    var d, e, g, l = [],
                        h = C,
                        p = []; - 1 !== b && (0 <= X.indexOf(b) ? (e = X.indexOf(b), X.splice(e, 1)) : (X.push(b), X = X.sort(function(a, b) { return a - b })));
                    if (0 === X.length) l = ha;
                    else {
                        e = C * (1 != X.length || 0 != X[0] && X[0] != O.length - 1 ? 2 : 1) / k();
                ...
                function k() { for (var a = 0, b = 0; b < O.length - 1; b++)(0 <= X.indexOf(b) || 0 <= X.indexOf(b + 1)) && a++; return a }
                ...
                var x = this;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    for (var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, z = this.plotArea, C = 0.025 * z.width, D = 0.01 * z.width, A = 0, E = z.height - 2 * C, F = Math.min(z.width - 2 * D, 2.8 * z.height), J = !1, H = 0; H < y.length; H++)
                        if (!J && ("undefined" !== typeof y[H].indexLabel && null !== y[H].indexLabel && 0 < y[H].indexLabel.toString().length) && (J = !0), !J && ("undefined" !== typeof y[H].label && null !== y[H].label && 0 < y[H].label.toString().length) && (J = !0), !J && "function" === typeof u.indexLabelFormatter ||
                            "function" === typeof y[H].indexLabelFormatter) J = !0;
                    J = J || "undefined" !== typeof u.indexLabel && null !== u.indexLabel && 0 < u.indexLabel.toString().length;
                    "inside" !== u.indexLabelPlacement && J || (D = (z.width - 0.75 * F) / 2);
                    var H = z.x1 + D,
                        M = z.x2 - D,
                        Y = z.y1 + C,
                        P = z.y2 - C,
                    ...
                    if (0 != u.length && (u.dataPoints && u.visible) && 0 !== y.length) {
                        ...
                        a = 75 * F / 100;
                        var U = 30 * (M - a) / 100;
                        "funnel" === u.type ? (ba = s(u.options.neckHeight) ? 0.35 * E : u.neckHeight, G = s(u.options.neckWidth) ? 0.25 * a : u.neckWidth, "string" ===
                            typeof ba && ba.match(/%$/) ? (ba = parseInt(ba), ba = ba * E / 100) : ba = parseInt(ba), "string" === typeof G && G.match(/%$/) ? (G = parseInt(G), G = G * a / 100) : G = parseInt(G), ba > E ? ba = E : 0 >= ba && (ba = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === u.type && (G = ba = 0, u.reversed = u.reversed ? !1 : !0);
                        var D = H + a / 2,
                            W = H,
                            T = H + a,
                            na = u.reversed ? P : Y,
                        ...
                        if (-1 !== H) {
                            if (u.reversed)
                                for (F.push(Z),
                                    G = H.length - 1; 0 < G; G--) Z += H[G], F.push(Z);
                            else
                                for (G = 0; G < H.length; G++) Z += H[G], F.push(Z);
                            if (u.reversed)
                                for (G = 0; G < H.length; G++) F[G] < xa ? (a.push(L), D.push($), ca = G) : (a.push((F[G] - na + V * W) / V), D.push((F[G] - na + ea * T) / ea));
                            else
                                for (G = 0; G < H.length; G++) F[G] < xa ? (a.push((F[G] - na + V * W) / V), D.push((F[G] - na + ea * T) / ea), ca = G) : (a.push(L), D.push($));
                            for (G = 0; G < H.length - 1; G++) Z = u.reversed ? y[y.length - 1 - G].color ? y[y.length - 1 - G].color : u._colorSet[(y.length - 1 - G) % u._colorSet.length] : y[G].color ? y[G].color : u._colorSet[G % u._colorSet.length],
                                G === ca ? O.push({ x1: a[G], y1: F[G], x2: D[G], y2: F[G], x3: $, y3: xa, x4: D[G + 1], y4: F[G + 1], x5: a[G + 1], y5: F[G + 1], x6: L, y6: xa, id: G, height: F[G + 1] - F[G], color: Z }) : O.push({ x1: a[G], y1: F[G], x2: D[G], y2: F[G], x3: D[G + 1], y3: F[G + 1], x4: a[G + 1], y4: F[G + 1], id: G, height: F[G + 1] - F[G], color: Z });
                            var da = 2,
                                I = [],
                                ga = !1,
                                X = [],
                            ...
                            a = a = 0;
                            Da(X);
                            for (G = 0; G < y.length; G++) y[G].exploded && (H = !0, u.reversed ? X.push(y.length - 1 - G) : X.push(G));
                            R.clearRect(z.x1, z.y1, z.width, z.height);
                            R.fillStyle = x.backgroundColor;
                            R.fillRect(z.x1, z.y1, z.width, z.height);
                            if (J && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) { l(); for (G = 0; G < y.length; G++) I[G].isDirty || (a = I[G].textBlock.x + I[G].width, a = (M - a) / 2, 0 == G && (A = a), A > a && (A = a)); for (G = 0; G < O.length; G++) O[G].x1 += A, O[G].x2 += A, O[G].x3 += A, O[G].x4 += A, O[G].x5 && (O[G].x5 += A, O[G].x6 += A), I[G].textBlock.x += A }
                            for (G = 0; G < O.length; G++) A = O[G], pa(R, A, u.fillOpacity), ha.push(A.y1);
                            v(R);
                            J && u.visible && ("inside" === u.indexLabelPlacement || x.animationEnabled || m(R), x.animationEnabled || r());
                            if (!J)
                                for (G = 0; G < y.length; G++) A = u.dataPointIds[G],
                                    a = { id: A, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: O[u.reversed ? y.length - 1 - G : G] }, x._eventManager.objectMap[A] = a;
                            !x.animationEnabled && H ? n(x, -1, 0) : x.animationEnabled && !x.animatedRender && n(x, -1, 0);
                            this.funnelPyramidClickHandler = function(a) {
                                var b = -1;
                                if (!ga && !x.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? y.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) {
                                    a = b;
                            ...
                            return {
                                ...
                                animationCallback: function(a, b) {
                                    ...
                                    1 <= a && (n(x, -1, 500), v(x.plotArea.ctx || x.ctx))
                                },
                                easingFunction: K.easing.easeInQuad,
                                animationBase: 0
                            }
        ...
        n.prototype.set = function(a, d, c) { c = "undefined" === typeof c ? !0 : c; "options" === a ? (this.options = d, c && this.render()) : n.base.set.call(this, a, d, c) };
        ...
        n.prototype.print = function() {
            ...
            U(d, { position: "absolute", width: "100%", border: "0px", margin: "0px 0px 0px 0px", padding: "0px 0px 0px 0px" });
        ...
        F.prototype.setLayout = function() {
                ...
                if (p.dataPoints && p.dataPoints.length)
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        ...
                        for (var y = 0; y < p.dataPoints.length; y++) {
                            var z = p.dataPoints[y],
                                q = z.legendMarkerType ? z.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : H.getDefaultLegendMarker(p.type),
                                g = z.legendText ? z.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: p, dataPoint: z }) : z.name ? z.name : "DataPoint: " +
                                (y + 1),
                                r = z.legendMarkerColor ? z.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : z.color ? z.color : p.color ? p.color : p._colorSet[y % p._colorSet.length],
                                w = 0.75 * this.lineHeight,
                                v = z.legendMarkerBorderColor ? z.legendMarkerBorderColor : p.legendMarkerBorderColor ? p.legendMarkerBorderColor : z.markerBorderColor ? z.markerBorderColor : p.markerBorderColor,
                                u = z.legendMarkerBorderThickness ? z.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : z.markerBorderThickness || p.markerBorderThickness ?
                                Math.max(1, Math.round(0.2 * w)) : 0,
                                g = this.chart.replaceKeywordsWithValue(g, z, p, y),
                                q = { markerType: q, markerColor: r, text: g, textBlock: null, chartType: p.type, markerSize: w, dataSeriesIndex: m, dataPointIndex: y, markerBorderColor: v, markerBorderThickness: u };
                            (z.showInLegend || p.showInLegend && !1 !== z.showInLegend) && n.push(q)
                        }
            ...
            if (0 < n.length) {
                ...
                for (m = 0; m < n.length; m++) {
                    ...
                    if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
                        ...
                        r = q.textBlock.width + (w + h + ("line" === q.chartType || "spline" ===
            ...
            this.items = n;
            for (m = 0; m < this.items.length; m++) q = n[m], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] = { id: q.id, objectType: "legendItem", legendItemIndex: m, dataSeriesIndex: q.dataSeriesIndex, dataPointIndex: q.dataPointIndex };
            this.markerSize = w;
            this.rows = k;
            0 < n.length && a.layoutManager.registerSpace(c, { width: this.width + 2 + 2, height: this.height + 5 + 5 });
                ...
                for (var k = l[n], m = 0, p = 0; p <
                    ...
                    if ("error" === q.chartType) {
                        ...
                        var w = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight,
                            ...
                            v = y + 0.02 * this.lineHeight;
                        this.ctx.moveTo(w, u);
                        this.ctx.lineTo(w + y, u);
                        this.ctx.stroke();
                        this.ctx.beginPath();
                        this.ctx.moveTo(w + y / 2, u);
                        this.ctx.lineTo(w + y / 2, u + v);
                        this.ctx.stroke();
                        this.ctx.beginPath();
                        this.ctx.moveTo(w, u + v);
                        this.ctx.lineTo(w + y, u + v);
                        this.ctx.stroke();
        ...
        H.prototype.getDataPointAtX =
            function(a, d) {
                ...
                "none" !== this.chart.plotInfo.axisPlacement && (this.axisX.logarithmic ? (m = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), m = 1 < m ? Math.min(Math.max((this.dataPoints.length - 1) / m * Math.log(a / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (m = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, m =
                    0 < m ? Math.min(Math.max((this.dataPoints.length - 1) / m * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0));
                for (;;) {
                    f = 0 < l ? m + e : m - e;
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "scatter":
                                ...
                                r <= w && b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: r });
                                q =
                                    Math.abs(q.x1 - a);
                                q <= n ? n = q : 0 < l ? k++ : m++;
                                r <= s / 2 && (h = !0);
                            ...
                            case "doughnut":
                                ...
                                r < q.radius && r > w && (r = Math.atan2(d - s.y, a - s.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (q.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), w = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === w && 1 < q.endAngle && (w = 360), s >= w && 0 !== g.y && (w += 360, r < s && (r += 360)), r > s && r < w && (b.push({
                                    dataPoint: g,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: 0
        ...
        E.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = q; b < this.logLabelValues.length; b++)
                        if (c =
                            ...
                            m = c;
                            a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: m, label: this.labels[m] ? this.labels[m] : null }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : da(m, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
                                x: 0,
                                y: 0,
                                maxWidth: f,
                                maxHeight: l,
                ...
                for (this.intervalStartPosition =
                    ...
                    a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: new Date(m), label: this.labels[m] ? this.labels[m] : null }) : "axisX" === this.type && this.labels[m] ?
                        this.labels[m] : Ba(m, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
                            x: 0,
                            y: 0,
                            maxWidth: f,
                            backgroundColor: this.labelBackgroundColor,
                    ...
                    if (f = 0.9 * h >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                for (var v, g = a.text.split(" "), b = 0; b < g.length; b++) m = g[b], this.ctx.font = a.fontStyle + " " +
                        ...
                        for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), m = (k - (n + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI /
                                        ...
                                        if (s(this.options.labelWrap))
                                            ...
                                            if (b = r.width + d.width >> 0, g = this.labelFontSize, q < f) b - 2 * f > p && (p = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, s(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ?
                                                ...
                                                g : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (s(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m) : b > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = g, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelAngle = this.labelAngle));
                                                ...
                                                q + this._labels[v - 1].textBlock.measureText().width - 2 * f > p)) p = 0 === v ? q + this._labels[v + 1].textBlock.measureText().width - 2 * f : q + this._labels[v - 1].textBlock.measureText().width - 2 * f, this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m;
                                        else if (0 === p)
                                    ...
                                    this.options.labelMaxWidth : m) : (s(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : m, this.sessionVariables.labelWrap = this.labelWrap), this.sessionVariables.labelMaxHeight = l)
                            }
            ...
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                } else l = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, x = s(f.options.labelWrap) || f.labelWrap ? "bottom" === this._position ||
        ...
        E.setLayout = function(a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks &&
                    ...
                    for (var r = q[g].scaleBreaks._appliedBreaks, w = 0; w < r.length && !(r[w].startValue > q[g].viewportMaximum); w++) r[w].endValue < q[g].viewportMinimum || (s(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w), r[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
            for (var v = w = 0, u = 0, y = 0, z = 0, x = 0, D = 0, A, E, F = h = 0, H, J, K, r = H = J = K = !1, g = 0; g < q.length; g++) q[g] && q[g].title && (q[g]._titleTextBlock = new ia(q[g].ctx, {
                text: q[g].title,
                horizontalAlign: "center",
            ...
            if ("normal" === e) {
                for (var y = [], z = [], x = [], D = [], M = [], N = [], P = [], R = []; 4 >
                    ...
                    var G = 0,
                        ...
                        $ = 0;
                    if (c && 0 < c.length)
                        for (x = [], g = O = 0; g < c.length; g++) x.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += x[g], L += c[g] && !m.isNavigator ? c[g].margin : 0;
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) L = m.isNavigator ? 0 : 10, c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + V + W < Math.max(L, p) ? Math.max(L, p) : f.y1 + V + W), n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height /
                            2 : p, k = Math.round(f.y2 - T - e - L), c[g].lineCoordinates = { x1: l - U, y1: h, x2: n - U, y2: k, height: Math.abs(k - h) }, "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (x[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0)) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2), c[g].bounds = { x1: l - (x[g] + U), y1: h, x2: n, y2: k, width: n - l, height: k - h }, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth <
                                c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), U += x[g] + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), n = Math.round(l), L = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + V + W < Math.max(L, p) ? Math.max(L, p) : f.y1 + V + W), L = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (T + e + L)), b[g].lineCoordinates = { x1: l + X, y1: h, x2: l + X, y2: k, height: Math.abs(k - h) }, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (D[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2, b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2), b[g].bounds = { x1: l, y1: h, x2: n + (D[g] + X), y2: k, width: n - l, height: k - h }, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.height ? b[g].titleMaxWidth :
                ...
                for (N = []; 4 > w;) {
                    ...
                    E.push(p);
                    if (b && 0 < b.length)
                        for (A = [], g = S = 0; g < b.length; g++) A.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), S += A[g], Z += b[g].margin;
                    ...
                    if (m.panEnabled)
                        for (g = 0; g < c.length; g++) p[g] = s(m.sessionVariables.axisY.height) ?
                            m.sessionVariables.axisY.height = p[g] : m.sessionVariables.axisY.height;
                    else
                        for (g = 0; g < c.length; g++) m.sessionVariables.axisY.height = p[g];
                    if (c && 0 < c.length)
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            ...
                            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - U) : f.y2 > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2;
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n, l =
                                    0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - X : l);
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (n = b[L].lineCoordinates.x1, l = n - X);
                            a[g].lineCoordinates = { x1: n - P, y1: h, x2: n - P, y2: k, height: Math.abs(k - h) };
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - U) : f.y2 > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2;
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n, l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - T : l);
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++) b[L] &&
                                    b[L].labelAutoFit && (n = b[L].lineCoordinates.x2, l = n - T);
                            d[g].lineCoordinates = { x1: n + R, y1: h, x2: n + R, y2: k, height: Math.abs(k - h) };
                            ...
                            d[g].bounds = { x1: d[g].lineCoordinates.x1, y1: h, x2: n + v[g] + R, y2: k, width: n - l, height: k - h };
                    ...
                    if (0 < w) {
                        ...
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) J = E[w - 1][g] === E[w][g] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length)
            ...
            if ("undefined" === typeof this.options.interval) {
                if ("bottom" === this._position || "top" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, l, h = this.viewportMaximum, n = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length -
                                1; 0 <= k; k--) {
                            p = this._labels[k];
                            if (p.position < this.viewportMinimum) break;
                            p.position > this.viewportMaximum || !(k === this._labels.length - 1 || l < Math.log(h / p.position) * n / e) || (c.push(p), h = p.position, l = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = c
                    } else {
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], m, h = this.viewportMaximum, n = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            p = this._labels[k];
                            if (p.position < this.viewportMinimum) break;
                            p.position > this.viewportMaximum || !(k === this._labels.length - 1 || m < Math.log(h / p.position) *
                                n) || (c.push(p), h = p.position, m = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = c
                    } else {
        ...
        E.prototype.renderStripLinesOfThicknessType = function(a) {
            if (this.stripLines &&
                ...
                if (!l) {
                    ...
                    for (b = 0; b < n.length; b++) c = n[b], c.stripLine.showOnTop ? l || (l = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                        for (e = 0; e < n.length; e++) c =
                            n[e], "inside" === c.stripLine.labelPlacement && c.stripLine.showOnTop && (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), c.textBlock.render(!0), d.ctx.restore())
        ...
        E.prototype.renderCrosshair = function(a, d) { isFinite(this.minimum) && isFinite(this.maximum) && (this.crosshair.render(a, d), this.crosshair.dispatchEvent("updated", { chart: this.chart, crosshair: this.options, axis: this, value: this.crosshair.value }, this)) };
        ...
        E.prototype.getXValueAt = function(a) { if (!a) return null; var d = null; "left" === this._position ? d = this.convertPixelToValue(a.y) : "bottom" === this._position && (d = this.convertPixelToValue(a.x)); return d };
        E.prototype.calculateValueToPixelConversionParameters =
            function(a) {
            ...
            if (this.logarithmic) this.calculateLogarithmicAxisParameters();
                ...
                if ("axisX" === this.type && c) {
                    this.intervalType ||
                        (b / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : b / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : b / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : b / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") : b / 20 <= a ? (this.interval = 20, this.intervalType = "millisecond") : b / 50 <= a ? (this.interval = 50, this.intervalType = "millisecond") : b / 100 <= a ? (this.interval = 100, this.intervalType = "millisecond") : b / 200 <= a ? (this.interval = 200, this.intervalType = "millisecond") : b / 250 <= a ? (this.interval = 250, this.intervalType =
                            ...
                            a ? (this.interval = 3, this.intervalType = "month") : b / (6 * R.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = b / (1 * R.yearDuration) <= a ? 1 : b / (2 * R.yearDuration) <= a ? 2 : b / (4 * R.yearDuration) <= a ? 4 : Math.floor(E.getNiceNumber(b / (a - 1), !0) / R.yearDuration), this.intervalType = "year"));
                    if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = e - h / 2;
                    if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = f + h / 2;
                    ...
                    if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = "axisX" === this.type ? f + h / 2 :
                ...
                if (null === this.minimum || null === this.maximum)
                    if ("axisX" === this.type ? (e = null !== this.minimum ? this.minimum : this.dataInfo.min, f = null !== this.maximum ?
                        ...
                        if (null === this.maximum || isNaN(this.maximum)) this.maximum = f + h / 2, this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum ||
                            isNaN(this.sessionVariables.viewportMaximum) ? -Infinity : this.sessionVariables.viewportMaximum)
                    } else this.intervalType = this.valueType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? e - h / 2 : Math.floor(e / this.interval) * this.interval, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum)), null === this.maximum && (this.maximum = "axisX" === this.type ? f + h / 2 : Math.ceil(f / this.interval) *
        ...
        E.prototype.calculateLogarithmicAxisParameters = function() {
            ...
            if (this.scaleBreaks)
                for (h =
                    ...
                    if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[h].startValue || !s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[h].startValue || !s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[h].startValue) && (!s(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[h].endValue ||
                            !s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[h].endValue || !s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[h].endValue)) { this.scaleBreaks._appliedBreaks.splice(h, 1); break }
                    "axisX" === this.type ? (b = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax, 1 === e / b && (h = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ?
            ...
            var n = (isNaN(this.viewportMaximum) || null === this.viewportMaximum ? e : this.viewportMaximum) - (isNaN(this.viewportMinimum) || null === this.viewportMinimum ? b : this.viewportMinimum);
            this.intervalType =
                "number";
            h = Math.pow(this.logarithmBase, E.getNiceNumber(Math.abs(Math.log(h) / d), !1));
            this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = E.getNiceExponent(Math.log(h) / d / (a - 1), !0), c = E.getNiceNumber(n / (a - 1), !0));
        ...
        V.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0, h = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, n = this.chart.plotArea.y2 + p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, n = this.chart.plotArea.y1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b - p / 2, y1: e, x2: h + p / 2, y2: n }, this.ctx.moveTo(b,
                            e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, n), this.ctx.lineTo(h, n), this.ctx.lineTo(h, e);
                    ...
                    if (e = 1 === p % 2 ? (e.y << 0) + 0.5 : e.y << 0, n = 1 === p % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, h = this.chart.plotArea.x2 + p / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2,
                            h = this.chart.plotArea.x1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b, y1: e - p / 2, x2: h, y2: n + p / 2 }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(h, e), this.ctx.lineTo(h, n), this.ctx.lineTo(b, n);
                    else if ("wavy" === this.type) {
                    s = b;
                    k = e;
                    f = 0.5;
        ...
        M.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 ===
                    this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, h = this.chart.plotArea.y1, n = this.chart.plotArea.y2, this.bounds = { x1: e - d / 2, y1: h, x2: f + d / 2, y2: n };
                else if ("left" === this.parent._position || "right" === this.parent._position) h = n = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, f = this.chart.plotArea.x2, this.bounds = { x1: e, y1: h - d / 2, x2: f, y2: n + d / 2 };
                this.ctx.moveTo(e, h);
                this.ctx.lineTo(f, n);
                this.ctx.stroke();
        ...
        ca.prototype.showAt = function(a) {
            ...
            for (b = 0; b < d.axisX2.length; b++) a = d.axisX2[b]._crosshairValue,
                d.axisX2[b].crosshair && (d.axisX2[b].crosshair.enabled && !s(a) && a >= d.axisX2[b].viewportMinimum && a <= d.axisX2[b].viewportMaximum) && (d.axisX2[b].showCrosshair(a), d.axisX2[b].crosshair._updatedValue = a, this === d.axisX2[b].crosshair && (c = !0));
            for (b = 0; b < d.axisY.length; b++) a = d.axisY[b]._crosshairValue, d.axisY[b].crosshair && (d.axisY[b].crosshair.enabled && !s(a) && a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum) && (d.axisY[b].showCrosshair(a), d.axisY[b].crosshair._updatedValue = a, this === d.axisY[b].crosshair &&
                (c = !0));
            for (b = 0; b < d.axisY2.length; b++) a = d.axisY2[b]._crosshairValue, d.axisY2[b].crosshair && (d.axisY2[b].crosshair.enabled && !s(a) && a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum) && (d.axisY2[b].showCrosshair(a), d.axisY2[b].crosshair._updatedValue = a, this === d.axisY2[b].crosshair && (c = !0));
        ...
        ca.prototype.render = function(a, d, c) {
            ...
            if (!this.valueFormatString)
                if ("dateTime" === this.parent.valueType) this.valueFormatString = this.parent.valueFormatString;
                    ...
                    var p = 0,
                        p = "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 < this.parent.range ? 0 : 500 < this.chart.width && 25 > this.parent.range ? 2 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0) : 50 < this.parent.range ? 0 : Math.floor(Math.abs(Math.log(this.parent.range) /
                            Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0);
                    this.valueFormatString = E.generateValueFormatString(this.parent.range, p)
                }
            ...
            q.lineWidth = p;
            q.save();
            this.labelFontSize = Math.abs(s(this.options.labelFontSize) ? this.parent.labelFontSize :
                this.labelFontSize);
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) r = this.parent.dataSeries[0].axisX.convertPixelToValue({ y: d });
                        ...
                        this.parent._position || "right" === this.parent._position) r = this.parent.convertPixelToValue({ y: d });
                    for (var x = 0; x < this.parent.dataSeries.length; x++)(v = this.parent.dataSeries[x].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[x], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    v = null;
                    if (0 === m.length) return;
                    m.sort(function(a, b) { return a.distance - b.distance });
                    v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                    x = 0;
                    if ("rangeBar" === m[0].dataSeries.type || "error" ===
                        m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[x].dataPoint.y[0])), u = 0, r = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (var y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, x = r);
                            else u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, x = r);
                    else if ("stackedBar" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), z = u = 0, r = x = 0; r <
                            m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, x = r);
                            else z += m[r].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, x = r);
                    else if ("stackedBar100" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), C = z = u = 0, r = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(a -
                                    this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, x = r);
                            else z += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (z / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(a - this.parent.convertValueToPixel(C)), u < v && (v = u, x = r);
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = x = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y])),
                                    u < v && (v = u, x = r);
                            else u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, x = r);
                    y = m[x];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type) {
                            ...
                            n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.y[b]) <<
                                0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.y[b]) << 0;
                            this.value = y.dataPoint.y[b];
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y[b] }) : s(this.options.label) ? da(c ? c : y.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar" === this.parent.dataSeries[x].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            z = u = 0;
                            for (r = x; 0 <= r; r--) z += m[r].dataPoint.y, u = Math.abs(a -
                                this.parent.convertValueToPixel(z)), u < v && (v = u, b = r);
                            n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z) << 0) + 0.5 : this.parent.convertValueToPixel(z) << 0;
                            this.value = z;
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y }) : s(this.options.label) ? da(c ? c : y.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar100" === this.parent.dataSeries[x].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            C = z = u = 0;
                            for (r = x; 0 <= r; r--) z += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (z / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(a - this.parent.convertValueToPixel(C)), u < v && (v = u, b = r);
                            n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(C) << 0) + 0.5 : this.parent.convertValueToPixel(C) << 0;
                            this.value = C;
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: C }) : s(this.options.label) ? da(c ? c : C,
                                this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.y) << 0, this.value = y.dataPoint.y, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y }) : s(this.options.label) ? da(c ? c : y.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        b = e = n;
                        ...
                        f =
                            h = w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.x) << 0;
                        ...
                        if (C) {
                            if ("axisX" === this.parent.type)
                                for (r = this.parent.convertPixelToValue({ y: d }), v = null, x = 0; x < this.parent.dataSeries.length; x++)(v =
                                    this.parent.dataSeries[x].getDataPointAtX(r, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x }) : s(this.options.label) ? v.dataPoint.label : this.label)
                        } else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x }) : s(this.options.label) ? Ba(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) :
                            this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x }) : s(this.options.label) ? da(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                        this.value = y.dataPoint.x;
                        k.y = h + k.fontSize / 2 - k.measureText().height / 2 + 2;
                        k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 -
                            k.measureText().height + k.fontSize / 2);
                    ...
                    for (x = 0; x < this.parent.dataSeries.length; x++)(v = this.parent.dataSeries[x].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[x], null !== v.dataPoint.y && v.dataSeries.visible &&
                        m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) { return a.distance - b.distance });
                    y = m[0];
                    ...
                    } else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x }) :
                        s(this.options.label) ? Ba(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x }) : s(this.options.label) ? da(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    this.value = y.dataPoint.x;
                    k.x = b - k.measureText().width / 2;
                    ...
                    for (x = 0; x < this.parent.dataSeries.length; x++)(v = this.parent.dataSeries[x].getDataPointAtX(r, !0)) && 0 <= v.index &&
                        (v.dataSeries = this.parent.dataSeries[x], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) { return a.distance - b.distance });
                    x = 0;
                    if ("rangeColumn" === m[0].dataSeries.type || "rangeArea" === m[0].dataSeries.type || "error" === m[0].dataSeries.type || "rangeSplineArea" === m[0].dataSeries.type || "candlestick" === m[0].dataSeries.type || "ohlc" === m[0].dataSeries.type || "boxAndWhisker" === m[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])),
                            r = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, x = r);
                            else u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, x = r);
                    else if ("stackedColumn" === m[0].dataSeries.type || "stackedArea" === m[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = z = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y <
                                    m[r].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, x = r);
                            else z += m[r].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, x = r);
                    else if ("stackedColumn100" === m[0].dataSeries.type || "stackedArea100" === m[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = C = z = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y])),
                                    u < v && (v = u, x = r);
                            else z += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (z / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(d - this.parent.convertValueToPixel(C)), u < v && (v = u, x = r);
                    else
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, x = r);
                            else u = Math.abs(d -
                                this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, x = r);
                    y = m[x];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[x].type || "rangeArea" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type || "rangeSplineArea" === this.parent.dataSeries[x].type || "candlestick" === this.parent.dataSeries[x].type || "ohlc" === this.parent.dataSeries[x].type || "boxAndWhisker" === this.parent.dataSeries[x].type) {
                        ...
                        for (r = u = 0; r < y.dataPoint.y.length; r++) u =
                            Math.abs(d - this.parent.convertValueToPixel(y.dataPoint.y[r])), u < v && (v = u, b = r);
                        ...
                        this.parent.dataSeries[x].type || "stackedArea" === this.parent.dataSeries[x].type) {
                        v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
                        z = u = 0;
                        for (r = x; 0 <= r; r--) z += m[r].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, b = r);
                        w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z) << 0) + 0.5 : this.parent.convertValueToPixel(z) << 0;
                        k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y }) : s(this.options.label) ?
                            da(c ? c : y.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        this.value = z
                    } else if ("stackedColumn100" === this.parent.dataSeries[x].type || "stackedArea100" === this.parent.dataSeries[x].type) {
                        v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
                        z = u = 0;
                        for (r = x; 0 <= r; r--) z += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (z / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(d - this.parent.convertValueToPixel(C)), u < v && (v = u, b = r);
                        w =
                            1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(C) << 0) + 0.5 : this.parent.convertValueToPixel(C) << 0;
                        k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: C }) : s(this.options.label) ? da(c ? c : C, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        this.value = C
                    } else "waterfall" === this.parent.dataSeries[x].type ? (w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) <<
                        ...
                        0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : y.dataPoint.y }) : s(this.options.label) ? da(c ? c : y.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataPoint.y);
                    f = h = w;
                    b = this.chart.plotArea.x1;
                    e = this.chart.plotArea.x2;
                    this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 };
                ...
                if ("left" === this.parent._position || "right" === this.parent._position) "left" === this.parent._position &&
                    k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1), "right" === this.parent._position && k.x + k.measureText().width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.measureText().width), h >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 < p && (q.moveTo(b, f), q.lineTo(e, h), q.stroke(), this._hidden = !1), q.restore())
            } else {
                if ("bottom" ===
                    this.parent._position || "top" === this.parent._position) b = e = n = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, h = this.chart.plotArea.y2, this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h };
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if (C) {
                            if ("axisX" === this.parent.type)
                                for (r = this.parent.convertPixelToValue({ y: d }), v = null, x = 0; x < this.parent.dataSeries.length; x++)(v = this.parent.dataSeries[x].getDataPointAtX(r, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) }) :
                                    s(this.options.label) ? v.dataPoint.label : this.label)
                        } else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(d) }) : s(this.options.label) ? Ba(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue(d)
                        }) : s(this.options.label) ? da(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label);
                        ...
                        "left" === this.parent._position ? k.x = this.parent.lineCoordinates.x1 - k.measureText().width :
                            "right" === this.parent._position && (k.x = this.parent.lineCoordinates.x2)
                    } else {
                        if ("bottom" === this.parent._position || "top" === this.parent._position) k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) }) : s(this.options.label) ? da(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label, k.x = b - k.measureText().width / 2, k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 -
                            k.width), k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1), "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
                    }
                else if ("bottom" === this.parent._position || "top" === this.parent._position) {
                    C = !1;
                    m = "";
                    ...
                    }) : s(this.options.label) ? Ba(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" }) : s(this.options.label) ? da(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) :
                        this.label);
                    k.x = b - k.measureText().width / 2;
                    k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width);
                    ...
                    "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
                        ...
                        crosshair: this.options,
                        value: c ? c : this.parent.convertPixelToValue(d)
                    }) : s(this.options.label) ? da(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label, k.y = d + k.fontSize / 2 - k.measureText().height / 2 + 2, k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height + k.fontSize / 2), "left" === this.parent._position ? k.x = this.parent.lineCoordinates.x2 -
                    k.measureText().width : "right" === this.parent._position && (k.x = this.parent.lineCoordinates.x2);
                "left" === this.parent._position && k.x < this.chart.bounds.x1 ? k.x = this.chart.bounds.x1 : "right" === this.parent._position && k.x + k.measureText().width > this.chart.bounds.x2 ? k.x = this.chart.bounds.x2 - k.measureText().width : "top" === this.parent._position && k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 : "bottom" === this.parent._position && this.parent.lineCoordinates.y2 - k.fontSize / 2 + k.measureText().height >
                    this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.height + k.fontSize / 2 + 2);
        ...
        ca.prototype.renderLabel = function() { s(this._textBlock) || (s(this._textBlock.text) || !("number" === typeof this._textBlock.text.valueOf() || 0 < this._textBlock.text.length) || this._hidden) || this._textBlock.render(!0) };
        oa(W, Z);
        ...
        W.prototype.mouseMoveHandler = function(a, d) { this._lastUpdated && 4 > (new Date).getTime() - this._lastUpdated || (this._lastUpdated = (new Date).getTime(), this.chart.resetOverlayedCanvas(), this._updateToolTip(a, d)) };
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var v = 0; v < this.chart.axisX.length; v++) {
                                for (var h = this.chart.axisX[v].convertPixelToValue({ y: d }),
                                        k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)(k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && n.push(k));
                                k = null
                            }
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++) {
                                ...
                                k = null;
                                for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b],
                        ...
                        if (this.chart.axisX)
                            for (v = 0; v < this.chart.axisX.length; v++)
                                for (h = this.chart.axisX[v].convertPixelToValue({ x: a }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)(k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && n.push(k));
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++)
                                for (h = this.chart.axisX2[v].convertPixelToValue({ x: a }), k = null, b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k =
                                    this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && n.push(k))
                    }
                    ...
                    if (b = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = b.dataPointIndex, this.currentSeriesIndex = b.dataSeries.index;
                        ...
                        if (b = Za(a, d, this.chart._eventManager.ghostCtx),
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        k = {};
                        if (0 <= this.currentDataPointIndex) b = e.dataPoints[this.currentDataPointIndex], k.dataSeries = e, k.dataPoint =
                            b, k.index = this.currentDataPointIndex, k.distance = Math.abs(b.x - h), "waterfall" === e.type && (k.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue, k.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum);
                        else {
                    ...
                    if (this.highlightObjects(f), this.enabled) {
                        ...
                        if (null !== c) {
                            ...
                            if (this.isToolTipDefinedInData && s(this.options.content) && s(this.options.contentFormatter))
                                for (h = this.contentDiv.getElementsByTagName("span"), b = 0, v = this.reversed ? f.length - 1 : 0; b < f.length, this.reversed ? 0 <= v : v < f.length; b++, this.reversed ? v-- : v++) h[b] && (h[b].style.color = this.chart.replaceKeywordsWithValue("{color}", f[v].dataPoint, f[v].dataSeries, f[v].index));
                            h = !1;
                            ...
                            try {
                                this.contentDiv.style.background =
                                    ...
                                    "Calibri, Arial, Georgia, serif;", this.contentDiv.style.fontWeight = this.fontWeight ? this.fontWeight : "normal", this.contentDiv.style.fontStyle = this.fontStyle ? this.fontStyle : w ? "italic" : "normal"
                            } catch (m) {}
                            "pie" === f[0].dataSeries.type || "doughnut" === f[0].dataSeries.type || "funnel" === f[0].dataSeries.type || "pyramid" === f[0].dataSeries.type || "bar" === f[0].dataSeries.type || "rangeBar" === f[0].dataSeries.type || "stackedBar" === f[0].dataSeries.type || "stackedBar100" === f[0].dataSeries.type ? a = a - 10 - this.container.clientWidth :
                            ...
                            d = 1 !== f.length || this.shared || "line" !== f[0].dataSeries.type && "stepLine" !== f[0].dataSeries.type && "spline" !== f[0].dataSeries.type && "area" !== f[0].dataSeries.type && "stepArea" !==
                                f[0].dataSeries.type && "splineArea" !== f[0].dataSeries.type ? "bar" === f[0].dataSeries.type || "rangeBar" === f[0].dataSeries.type || "stackedBar" === f[0].dataSeries.type || "stackedBar100" === f[0].dataSeries.type ? f[0].dataSeries.axisX.convertValueToPixel(f[0].dataPoint.x) : d : f[0].dataSeries.axisY.convertValueToPixel(f[0].dataPoint.y);
                            d = -d + 10;
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    var b = this.chart.data[e.dataSeriesIndex],
                        ...
                        h = e.dataPointIndex;
                    !1 === f.highlightEnabled || !0 !== b.highlightEnabled && !0 !== f.highlightEnabled || ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "scatter" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" ===
                        b.type || "stackedArea" === b.type || "stackedArea100" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type ? (f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#FFFFFF", f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size), $.drawMarkers([f]), "undefined" !== typeof e.y2 && (f = b.getMarkerProperties(h, e.x1, e.y2, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#FFFFFF", f.borderThickness =
                            ...
                            d.globalAlpha = 1, d.strokeStyle = e.stemColor, d.lineWidth = 2 * e.stemThickness, 0 < e.stemThickness && (d.beginPath(), d.moveTo(e.x3, e.y2 + e.borderThickness / 2), d.lineTo(e.x3, e.y1 + e.whiskerThickness / 2), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4 - e.whiskerThickness / 2), d.lineTo(e.x3, e.y3 - e.borderThickness / 2), d.stroke()), d.beginPath(), ea(d, e.x1 - e.borderThickness / 2, Math.max(e.y2 + e.borderThickness / 2, e.y3 + e.borderThickness / 2), e.x2 + e.borderThickness / 2, Math.min(e.y2 - e.borderThickness / 2, e.y3 - e.borderThickness / 2), "transparent",
                                ...
                                e.y5), d.lineTo(e.x2, e.y5), d.stroke()), d.restore(), d.globalAlpha = 1) : "error" === b.type && x(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3))
                }
            }
            d.restore();
            d.globalAlpha = 1;
        ...
        W.prototype.getToolTipInnerHTML = function(a) {
            ...
            if (this.isToolTipDefinedInData &&
                ...
                for (var n = null, s = "", h = 0; h < a.length; h++) c = a[h].dataSeries, b = a[h].dataPoint, e = a[h].index, f = "", 0 === h && (this.isToolTipDefinedInData && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? s += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ? this.chart.axisX[0].labels[b.x] :
        ...
        W.prototype.hide = function(a) { this.container && (this.container.style.display = "none", this.currentSeriesIndex = -1, this._prevY = this._prevX = NaN, ("undefined" === typeof a || a) && this.chart.resetOverlayedCanvas()) };
        W.prototype.show = function(a, d, c) { this._updateToolTip(a, d, "undefined" === typeof c ? !1 : c) };
        ...
        W.prototype.showAtX = function(a, d) {
            ...
            if (0 < f.length) {
                ...
                if (null !== h) {
                    ...
                    if (this.isToolTipDefinedInData && s(this.options.content) && s(this.options.contentFormatter))
                        for (b = this.contentDiv.getElementsByTagName("span"), h = 0, e = this.reversed ? f.length - 1 : 0; h < f.length,
                            this.reversed ? 0 <= e : e < f.length; h++, this.reversed ? e-- : e++) b[h] && (b[h].style.color = this.chart.replaceKeywordsWithValue("{color}", f[e].dataPoint, f[e].dataSeries, f[e].index));
                    h = !1;
                    "none" === this.container.style.display && (h = !0, this.container.style.display = "block");
                    try {
        ...
        W.prototype.getContainerTransition = function(a) { return "left " + a + "s ease-out 0s, bottom " + a + "s ease-out 0s" };
